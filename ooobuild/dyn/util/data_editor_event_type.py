...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    DataEditorEventType = gen_dynamic_enum("com.sun.star.util.DataEditorEventType")
    # Dynamically created class that represents ``com.sun.star.util.DataEditorEventType`` Enum.
else:
