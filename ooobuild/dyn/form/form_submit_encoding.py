...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    FormSubmitEncoding = gen_dynamic_enum("com.sun.star.form.FormSubmitEncoding")
    # Dynamically created class that represents ``com.sun.star.form.FormSubmitEncoding`` Enum.
else:
