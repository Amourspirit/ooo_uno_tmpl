...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    NavigationBarMode = gen_dynamic_enum("com.sun.star.form.NavigationBarMode")
    # Dynamically created class that represents ``com.sun.star.form.NavigationBarMode`` Enum.
else:
