...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    DataSelectionType = gen_dynamic_enum("com.sun.star.form.DataSelectionType")
    # Dynamically created class that represents ``com.sun.star.form.DataSelectionType`` Enum.
else:
