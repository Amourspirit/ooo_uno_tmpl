...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    RememberAuthentication = gen_dynamic_enum("com.sun.star.ucb.RememberAuthentication")
    # Dynamically created class that represents ``com.sun.star.ucb.RememberAuthentication`` Enum.
else:
