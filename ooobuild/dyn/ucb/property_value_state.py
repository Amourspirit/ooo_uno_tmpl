...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    PropertyValueState = gen_dynamic_enum("com.sun.star.ucb.PropertyValueState")
    # Dynamically created class that represents ``com.sun.star.ucb.PropertyValueState`` Enum.
else:
