...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    RemoteContentProviderChangeAction = gen_dynamic_enum("com.sun.star.ucb.RemoteContentProviderChangeAction")
    # Dynamically created class that represents ``com.sun.star.ucb.RemoteContentProviderChangeAction`` Enum.
else:
