...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    DocumentStoreMode = gen_dynamic_enum("com.sun.star.ucb.DocumentStoreMode")
    # Dynamically created class that represents ``com.sun.star.ucb.DocumentStoreMode`` Enum.
else:
