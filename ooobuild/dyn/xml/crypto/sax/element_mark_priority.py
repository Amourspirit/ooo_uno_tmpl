...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    ElementMarkPriority = gen_dynamic_enum("com.sun.star.xml.crypto.sax.ElementMarkPriority")
    # Dynamically created class that represents ``com.sun.star.xml.crypto.sax.ElementMarkPriority`` Enum.
else:
