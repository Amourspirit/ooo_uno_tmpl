...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    VerticalAlignment = gen_dynamic_enum("com.sun.star.style.VerticalAlignment")
    # Dynamically created class that represents ``com.sun.star.style.VerticalAlignment`` Enum.
else:
