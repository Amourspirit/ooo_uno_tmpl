...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    HorizontalAlignment = gen_dynamic_enum("com.sun.star.style.HorizontalAlignment")
    # Dynamically created class that represents ``com.sun.star.style.HorizontalAlignment`` Enum.
else:
