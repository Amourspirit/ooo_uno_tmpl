...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    ConditionOperator = gen_dynamic_enum("com.sun.star.sheet.ConditionOperator")
    # Dynamically created class that represents ``com.sun.star.sheet.ConditionOperator`` Enum.
else:
