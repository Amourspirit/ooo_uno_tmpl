...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    HorizontalDimensioning = gen_dynamic_enum("com.sun.star.drawing.HorizontalDimensioning")
    # Dynamically created class that represents ``com.sun.star.drawing.HorizontalDimensioning`` Enum.
else:
