...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    TextHorizontalAdjust = gen_dynamic_enum("com.sun.star.drawing.TextHorizontalAdjust")
    # Dynamically created class that represents ``com.sun.star.drawing.TextHorizontalAdjust`` Enum.
else:
