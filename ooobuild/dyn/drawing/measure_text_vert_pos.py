...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    MeasureTextVertPos = gen_dynamic_enum("com.sun.star.drawing.MeasureTextVertPos")
    # Dynamically created class that represents ``com.sun.star.drawing.MeasureTextVertPos`` Enum.
else:
