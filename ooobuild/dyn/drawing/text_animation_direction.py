...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    TextAnimationDirection = gen_dynamic_enum("com.sun.star.drawing.TextAnimationDirection")
    # Dynamically created class that represents ``com.sun.star.drawing.TextAnimationDirection`` Enum.
else:
