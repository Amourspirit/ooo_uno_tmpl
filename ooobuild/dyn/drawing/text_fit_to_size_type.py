...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    TextFitToSizeType = gen_dynamic_enum("com.sun.star.drawing.TextFitToSizeType")
    # Dynamically created class that represents ``com.sun.star.drawing.TextFitToSizeType`` Enum.
else:
