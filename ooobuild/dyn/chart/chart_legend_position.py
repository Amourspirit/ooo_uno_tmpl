...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    ChartLegendPosition = gen_dynamic_enum("com.sun.star.chart.ChartLegendPosition")
    # Dynamically created class that represents ``com.sun.star.chart.ChartLegendPosition`` Enum.
else:
