...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    ChartRegressionCurveType = gen_dynamic_enum("com.sun.star.chart.ChartRegressionCurveType")
    # Dynamically created class that represents ``com.sun.star.chart.ChartRegressionCurveType`` Enum.
else:
