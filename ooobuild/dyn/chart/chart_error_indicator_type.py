...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    ChartErrorIndicatorType = gen_dynamic_enum("com.sun.star.chart.ChartErrorIndicatorType")
    # Dynamically created class that represents ``com.sun.star.chart.ChartErrorIndicatorType`` Enum.
else:
