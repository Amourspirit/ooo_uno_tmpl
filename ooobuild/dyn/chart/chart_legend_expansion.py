...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    ChartLegendExpansion = gen_dynamic_enum("com.sun.star.chart.ChartLegendExpansion")
    # Dynamically created class that represents ``com.sun.star.chart.ChartLegendExpansion`` Enum.
else:
