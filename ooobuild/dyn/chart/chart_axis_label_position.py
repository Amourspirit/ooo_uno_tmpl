...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    ChartAxisLabelPosition = gen_dynamic_enum("com.sun.star.chart.ChartAxisLabelPosition")
    # Dynamically created class that represents ``com.sun.star.chart.ChartAxisLabelPosition`` Enum.
else:
