...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    ChartErrorCategory = gen_dynamic_enum("com.sun.star.chart.ChartErrorCategory")
    # Dynamically created class that represents ``com.sun.star.chart.ChartErrorCategory`` Enum.
else:
