...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    ChartDataChangeType = gen_dynamic_enum("com.sun.star.chart.ChartDataChangeType")
    # Dynamically created class that represents ``com.sun.star.chart.ChartDataChangeType`` Enum.
else:
