...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    ChartAxisMarkPosition = gen_dynamic_enum("com.sun.star.chart.ChartAxisMarkPosition")
    # Dynamically created class that represents ``com.sun.star.chart.ChartAxisMarkPosition`` Enum.
else:
