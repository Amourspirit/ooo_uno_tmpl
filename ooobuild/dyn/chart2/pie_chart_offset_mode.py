...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    PieChartOffsetMode = gen_dynamic_enum("com.sun.star.chart2.PieChartOffsetMode")
    # Dynamically created class that represents ``com.sun.star.chart2.PieChartOffsetMode`` Enum.
else:
