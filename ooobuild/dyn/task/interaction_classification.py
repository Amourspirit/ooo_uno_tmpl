...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    InteractionClassification = gen_dynamic_enum("com.sun.star.task.InteractionClassification")
    # Dynamically created class that represents ``com.sun.star.task.InteractionClassification`` Enum.
else:
