...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    TableSortFieldType = gen_dynamic_enum("com.sun.star.table.TableSortFieldType")
    # Dynamically created class that represents ``com.sun.star.table.TableSortFieldType`` Enum.
else:
