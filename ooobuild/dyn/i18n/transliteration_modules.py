...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    TransliterationModules = gen_dynamic_enum("com.sun.star.i18n.TransliterationModules")
    # Dynamically created class that represents ``com.sun.star.i18n.TransliterationModules`` Enum.
else:
