...
from ...parser import __version__, JSON_ID, enm, base
...
class WriterEnums:
    def __init__(self, parser: ParserEnum) -> None:
        ...
        # self._proc = Path(self._parser.app_root, 'parser', 'enm.py')
        self._proc = Path(enm.__file__)
...
def parse(**kwargs):
    ...
    p = ParserEnum(json_path=_json_file)
