...
__CHEETAH_genTime__ = 1684704708.2264607
__CHEETAH_genTimestamp__ = 'Sun May 21 17:31:48 2023'
__CHEETAH_src__ = '_struct_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Sun May 21 17:31:38 2023'
...
''')
        ...
        write("""    typeName: str = '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 87, col 22
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 87, col 22.
        write("""'
...
""")
        ...
        Arguments:
''')
        for arg in VFFSL(SL,"args_all",True): # generated from line 97, col 1
            arg_type = re.sub(re_underscore_hex, '', VFFSL(SL,"arg.type",True), 1)
            write('''            ''')
            _v = VFFSL(SL,"arg.name",True) # '$arg.name' on line 99, col 13
            if _v is not None: write(_filter(_v, rawExpr='$arg.name')) # from line 99, col 13.
            write(''' (''')
            _v = VFFSL(SL,"arg_type",True) # '$arg_type' on line 99, col 24
            if _v is not None: write(_filter(_v, rawExpr='$arg_type')) # from line 99, col 24.
            write(''', optional): ''')
            _v = VFFSL(SL,"arg.name",True) # '$arg.name' on line 99, col 46
            if _v is not None: write(_filter(_v, rawExpr='$arg.name')) # from line 99, col 46.
            write(''' value.
''')
        write('''        """
        ...
...
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 104, col 1
            ...
            write('''    @property
    def ''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 109, col 9
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 109, col 9.
            write('''(self) -> ''')
            _v = VFFSL(SL,"itm",True)['type'] # "$itm['type']" on line 109, col 30
            if _v is not None: write(_filter(_v, rawExpr="$itm['type']")) # from line 109, col 30.
            write(''':
''')
            if VFFSL(SL,"include_desc",True) and VFFSL(SL,"itm",True)['desc']: # generated from line 110, col 1
                write('''        """
''')
                if isinstance(VFFSL(SL,"itm",True)['desc'], str): # generated from line 112, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"itm",True)['desc'] # "$itm['desc']" on line 113, col 9
                    if _v is not None: write(_filter(_v, rawExpr="$itm['desc']")) # from line 113, col 9.
                    write('''
''')
                else: # generated from line 114, col 5
                    for line in VFFSL(SL,"itm",True)['desc']: # generated from line 115, col 9
                        write('''        ''')
...
''')
            write('''    @''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 124, col 6
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 124, col 6.
            write('''.setter
    def ''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 125, col 9
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 125, col 9.
            write('''(self, value: ''')
            _v = VFFSL(SL,"itm",True)['type'] # "$itm['type']" on line 125, col 34
            if _v is not None: write(_filter(_v, rawExpr="$itm['type']")) # from line 125, col 34.
            write(''') -> None:
        ...
''')
