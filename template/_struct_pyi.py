...
__CHEETAH_genTime__ = 1684081319.9926362
__CHEETAH_genTimestamp__ = 'Sun May 14 12:21:59 2023'
__CHEETAH_src__ = '_struct_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Sun May 14 12:21:37 2023'
...
''')
            write('''    @''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 123, col 6
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 123, col 6.
            write('''.setter
    def ''')
            ...
            write('''(self, value: ''')
            _v = VFFSL(SL,"itm",True)['type'] # "$itm['type']" on line 124, col 34
            if _v is not None: write(_filter(_v, rawExpr="$itm['type']")) # from line 124, col 34.
            write(''') -> None:
        ...
''')
