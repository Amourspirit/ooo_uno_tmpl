...
__CHEETAH_genTime__ = 1644605574.703406
__CHEETAH_genTimestamp__ = 'Fri Feb 11 13:52:54 2022'
__CHEETAH_src__ = '_typedef.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Feb 11 13:52:51 2022'
...
''')
        ...
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 35, col 1
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 35, col 1.
        write(""" = typing.NewType('""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 35, col 30
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 35, col 30.
        write("""', """)
        _v = VFFSL(SL,"type",True) # '$type' on line 35, col 43
        if _v is not None: write(_filter(_v, rawExpr='$type')) # from line 35, col 43.
        write(''')
''')
        if VFFSL(SL,"include_desc",True): # generated from line 36, col 1
            write('''"""
TypeDef type alias

''')
            for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"desc",True)): # generated from line 40, col 1
                _v = VFFSL(SL,"line",True) # '$line' on line 41, col 1
                if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 41, col 1.
                write('''
''')
...
See Also:
    `API ''')
                _v = VFFSL(SL,"name",True) # '$name' on line 46, col 10
                if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 46, col 10.
                write(''' <''')
                _v = VFFSL(SL,"link",True) # '$link' on line 46, col 17
                if _v is not None: write(_filter(_v, rawExpr='$link')) # from line 46, col 17.
                write('''>`_
''')
            write('''"""
''')
