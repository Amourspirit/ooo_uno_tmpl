...
__CHEETAH_genTime__ = 1642712849.4540527
__CHEETAH_genTimestamp__ = 'Thu Jan 20 16:07:29 2022'
__CHEETAH_src__ = '_typedef.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Jan 20 16:00:34 2022'
...
''')
        ...
        _v = VFFSL(SL,"type",True) # '$type' on line 34, col 34
        if _v is not None: write(_filter(_v, rawExpr='$type')) # from line 34, col 34.
        write('''
''')
        if VFFSL(SL,"include_desc",True): # generated from line 35, col 1
            write('''"""
''')
            for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"desc",True)): # generated from line 37, col 1
                _v = VFFSL(SL,"line",True) # '$line' on line 38, col 1
                if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 38, col 1.
                write('''
''')
...
See Also:
    `API ''')
                _v = VFFSL(SL,"name",True) # '$name' on line 43, col 10
                if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 43, col 10.
                write(''' <''')
                _v = VFFSL(SL,"link",True) # '$link' on line 43, col 17
                if _v is not None: write(_filter(_v, rawExpr='$link')) # from line 43, col 17.
                write('''>`_
''')
            write('''"""
''')
