...
__CHEETAH_genTime__ = 1656696151.5229445
__CHEETAH_genTimestamp__ = 'Fri Jul  1 13:22:31 2022'
__CHEETAH_src__ = '_typedef.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Jul  1 12:57:21 2022'
...
''')
        ...
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 39, col 1
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 39, col 1.
        write(""" = typing.NewType('""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 39, col 30
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 39, col 30.
        write("""', """)
        _v = VFFSL(SL,"type",True) # '$type' on line 39, col 43
        if _v is not None: write(_filter(_v, rawExpr='$type')) # from line 39, col 43.
        write(''')
''')
...
''')
            for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"desc",True)): # generated from line 44, col 1
                _v = VFFSL(SL,"line",True) # '$line' on line 45, col 1
                if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 45, col 1.
                write('''
''')
