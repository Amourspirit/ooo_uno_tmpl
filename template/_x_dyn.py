...
__CHEETAH_genTime__ = 1644265117.247877
__CHEETAH_genTimestamp__ = 'Mon Feb  7 15:18:37 2022'
__CHEETAH_src__ = '_x_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Mon Feb  7 15:16:25 2022'
...
if not TYPE_CHECKING and _DYNAMIC:
    from ''')
        _v = VFFSL(SL,"uno_helper_namespace",True) # '$uno_helper_namespace' on line 51, col 10
        if _v is not None: write(_filter(_v, rawExpr='$uno_helper_namespace')) # from line 51, col 10.
    ...
    def _dynamic_interface() -> None:
        ...
        write(""" = unoclass('""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 55, col 32
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 55, col 32.
        write("""')
        setattr(""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 56, col 17
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 56, col 17.
        write(""", ' __ooo_ns__', '""")
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 56, col 45
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 56, col 45.
        write("""')
        setattr(""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 57, col 17
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 57, col 17.
        ...
        write("""')
        setattr(""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 58, col 17
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 58, col 17.
