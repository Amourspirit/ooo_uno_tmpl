...
__CHEETAH_genTime__ = 1656696151.6604898
__CHEETAH_genTimestamp__ = 'Fri Jul  1 13:22:31 2022'
__CHEETAH_src__ = '_typedef_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Jul  1 13:02:24 2022'
...
''')
        ...
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 38, col 1
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 38, col 1.
        write(""" = typing.NewType('""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 38, col 30
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 38, col 30.
        write("""', """)
        _v = VFFSL(SL,"type",True) # '$type' on line 38, col 43
        if _v is not None: write(_filter(_v, rawExpr='$type')) # from line 38, col 43.
        write(''')
''')
        if VFFSL(SL,"include_desc",True): # generated from line 39, col 1
            write('''"""
TypeDef type alias

''')
            for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"desc",True)): # generated from line 43, col 1
...
See Also:
    `API ''')
                _v = VFFSL(SL,"name",True) # '$name' on line 49, col 10
                if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 49, col 10.
                write(''' <''')
                _v = VFFSL(SL,"link",True) # '$link' on line 49, col 17
                if _v is not None: write(_filter(_v, rawExpr='$link')) # from line 49, col 17.
                write('''>`_
''')
            write('''"""
''')
