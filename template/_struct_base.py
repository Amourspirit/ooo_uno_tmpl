...
__CHEETAH_genTime__ = 1643485088.9644015
__CHEETAH_genTimestamp__ = 'Sat Jan 29 14:38:08 2022'
__CHEETAH_src__ = '_struct_base.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Jan 29 14:38:05 2022'
...
''')
        if VFFSL(SL,"libre_office_ver",True): # generated from line 33, col 1
            ...
            write('''
''')
        if VFFSL(SL,"dynamic_struct",True): # generated from line 36, col 1
            write('''import os
''')
...
''')
            for imp in VFFSL(SL,"from_imports_typing",True): # generated from line 50, col 1
                ...
                write('''
''')
        if VFFSL(SL,"dynamic_struct",True): # generated from line 54, col 1
            write('''from ooo_uno.oenv import UNO_ENVIRONMENT
...
''')
        if VFFSL(SL,"allow_db",True): # generated from line 61, col 1
            ...
            write('''(''')
            _v = VFN(VFFSL(SL,"self",True),"get_class_inherits_from_db",False)() # '$self.get_class_inherits_from_db()' on line 62, col 20
            if _v is not None: write(_filter(_v, rawExpr='$self.get_class_inherits_from_db()')) # from line 62, col 20.
            write('''):
''')
            ...
            write('''):
''')
        if VFFSL(SL,"include_desc",True): # generated from line 66, col 1
            write('''    """
    Struct Class
...
''')
            write('''
''')
            if VFFSL(SL,"dynamic_struct",True): # generated from line 83, col 5
                write('''
    Note:
        | At runtime ''')
                _v = VFFSL(SL,"name",True) # '$name' on line 86, col 22
                if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 86, col 22.
                write(''' will be an actual uno struct however can seamlessly be treated as a regualr class.
        | At design time a class is presumed. This allows for better typings.
        | ''')
                _v = VFFSL(SL,"name",True) # '$name' on line 88, col 11
                if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 88, col 11.
...
''')
        ...
        _v = VFN(VFFSL(SL,"self",True),"get_constructor_str",False)(opt=True) # '$self.get_constructor_str(opt=True)' on line 93, col 24
        if _v is not None: write(_filter(_v, rawExpr='$self.get_constructor_str(opt=True)')) # from line 93, col 24.
        write('''):
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 94, col 1
            ...
            write('''        self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 98, col 15
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 98, col 15.
            write(''' = ''')
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 98, col 49
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 98, col 49.
            write('''
''')
    ...
    @property
    def ''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 106, col 9
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 106, col 9.
            write('''(self) -> ''')
            _v = VFFSL(SL,"itm.type",True) # '$itm.type' on line 106, col 30
            if _v is not None: write(_filter(_v, rawExpr='$itm.type')) # from line 106, col 30.
            write(''':
''')
            if VFFSL(SL,"include_desc",True) and VFFSL(SL,"itm.lines",True): # generated from line 107, col 5
                write('''        """
''')
                if isinstance(VFFSL(SL,"itm.lines",True), str): # generated from line 109, col 9
                    write('''        ''')
                    _v = VFFSL(SL,"itm.lines",True) # '$itm.lines' on line 110, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$itm.lines')) # from line 110, col 9.
                    write('''
''')
                else: # generated from line 111, col 9
                    for line in VFFSL(SL,"itm.lines",True): # generated from line 112, col 13
                        write('''        ''')
...
''')
            write('''        return self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 118, col 22
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 118, col 22.
            write('''
    
    @''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 120, col 6
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 120, col 6.
            write('''.setter
    def ''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 121, col 9
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 121, col 9.
            write('''(self, value: ''')
            _v = VFFSL(SL,"itm.type",True) # '$itm.type' on line 121, col 34
            if _v is not None: write(_filter(_v, rawExpr='$itm.type')) # from line 121, col 34.
            write(''') -> None:
        self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 122, col 15
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 122, col 15.
            write(''' = value
''')
        if VFFSL(SL,"dynamic_struct",True): # generated from line 124, col 1
            write('''
def _dynamic_struct() -> None:
    # Dynamically create uno struct using uno
    global ''')
            _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 128, col 12
            if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 128, col 12.
            write("""
    ...
    if (not typing.TYPE_CHECKING) and UNO_ENVIRONMENT:
        order = (""")
            _v = VFN(VFFSL(SL,"self",True),"get_nt_names_str",False)() # '$self.get_nt_names_str()' on line 133, col 18
            if _v is not None: write(_filter(_v, rawExpr='$self.get_nt_names_str()')) # from line 133, col 18.
            write(""")
        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('""")
            _v = VFFSL(SL,"fullname",True) # '${fullname}' on line 135, col 52
            if _v is not None: write(_filter(_v, rawExpr='${fullname}')) # from line 135, col 52.
            write("""')
            ...
            return struct
        """)
            _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 143, col 9
            if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 143, col 9.
            write(''' = _struct_init
...
''')
        write("""
__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 149, col 13
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 149, col 13.
        write("""']""")
