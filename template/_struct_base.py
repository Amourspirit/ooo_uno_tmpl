...
__CHEETAH_genTime__ = 1647129806.4584572
__CHEETAH_genTimestamp__ = 'Sat Mar 12 19:03:26 2022'
__CHEETAH_src__ = '_struct_base.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Mar 12 19:03:22 2022'
...
''')
        if VFN(VFFSL(SL,"self",True),"is_args",False)(): # generated from line 109, col 1
            write('''
        if isinstance(''')
            _v = VFN(VFFSL(SL,"args_all",True)[0],"name",True) # '$args_all[0].name' on line 111, col 23
            if _v is not None: write(_filter(_v, rawExpr='$args_all[0].name')) # from line 111, col 23.
            write(''', ''')
            _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 111, col 42
            if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 111, col 42.
            write('''):
            oth: ''')
            _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 112, col 18
            if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 112, col 18.
            write(''' = ''')
            _v = VFN(VFFSL(SL,"args_all",True)[0],"name",True) # '$args_all[0].name' on line 112, col 31
            if _v is not None: write(_filter(_v, rawExpr='$args_all[0].name')) # from line 112, col 31.
            write('''
''')
            for arg in VFFSL(SL,"args_all",True): # generated from line 113, col 5
                write('''            self.''')
                _v = VFFSL(SL,"arg.name",True) # '$arg.name' on line 114, col 18
                if _v is not None: write(_filter(_v, rawExpr='$arg.name')) # from line 114, col 18.
                write(''' = oth.''')
                _v = VFFSL(SL,"arg.name",True) # '$arg.name' on line 114, col 34
                if _v is not None: write(_filter(_v, rawExpr='$arg.name')) # from line 114, col 34.
                write('''
''')
            write('''            return
...
''')
            for arg in VFFSL(SL,"args_all",True): # generated from line 119, col 5
                write('''            "''')
                _v = VFFSL(SL,"arg.name",True) # '$arg.name' on line 120, col 14
                if _v is not None: write(_filter(_v, rawExpr='$arg.name')) # from line 120, col 14.
                write('''": ''')
                _v = VFFSL(SL,"arg.name",True) # '$arg.name' on line 120, col 26
                if _v is not None: write(_filter(_v, rawExpr='$arg.name')) # from line 120, col 26.
                write(''',
''')
            write('''        }
''')
            for arg in VFFSL(SL,"args_all",True): # generated from line 123, col 5
                if VFFSL(SL,"arg.default",True) == "UNO_NONE": # generated from line 124, col 9
                    write('''        if kargs["''')
                    _v = VFFSL(SL,"arg.name",True) # '$arg.name' on line 125, col 19
                    if _v is not None: write(_filter(_v, rawExpr='$arg.name')) # from line 125, col 19.
                    write('''"] is UNO_NONE:
            kargs["''')
                    _v = VFFSL(SL,"arg.name",True) # '$arg.name' on line 126, col 20
                    if _v is not None: write(_filter(_v, rawExpr='$arg.name')) # from line 126, col 20.
                    write('''"] = None
''')
...
''')
            if VFFSL(SL,"is_local_args",True): # generated from line 133, col 9
                for arg in VFFSL(SL,"args_local",True): # generated from line 134, col 13
                    write('''        self._''')
                    _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"arg.name",True)) # '$self.camel_to_snake($arg.name)' on line 135, col 15
                    if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($arg.name)')) # from line 135, col 15.
                    write(''' = kwargs["''')
                    _v = VFFSL(SL,"arg.name",True) # '$arg.name' on line 135, col 57
                    if _v is not None: write(_filter(_v, rawExpr='$arg.name')) # from line 135, col 57.
                    write('''"]
''')
            if VFFSL(SL,"is_non_local_args",True): # generated from line 138, col 9
                if VFFSL(SL,"is_local_args",True): # generated from line 139, col 13
                    write('''        inst_keys = (''')
                    _v = VFN(VFFSL(SL,"self",True),"get_nt_names_str",False)() # '$self.get_nt_names_str()' on line 140, col 22
                    if _v is not None: write(_filter(_v, rawExpr='$self.get_nt_names_str()')) # from line 140, col 22.
                    write(''')
        kargs = kwargs.copy()
        ...
        super()._init(**kargs)
''')
                else: # generated from line 145, col 13
                    write('''        super()._init(**kwargs)
''')
            else: # generated from line 148, col 9
                if VFN(VFFSL(SL,"self",True),"has_uno_extends",False)(): # generated from line 149, col 13
                    write('''        super()._init({})
''')
            #  #end if
        write('''
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 156, col 1
            index = tpl[1]
    ...
    @property
    def ''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 162, col 9
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 162, col 9.
            write('''(self) -> ''')
            _v = VFFSL(SL,"itm",True)['type'] # "$itm['type']" on line 162, col 30
            if _v is not None: write(_filter(_v, rawExpr="$itm['type']")) # from line 162, col 30.
            write(''':
''')
            if VFFSL(SL,"include_desc",True) and VFFSL(SL,"itm",True)['desc']: # generated from line 163, col 1
                write('''        """
''')
                if isinstance(VFFSL(SL,"itm",True)['desc'], str): # generated from line 165, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"itm",True)['desc'] # "$itm['desc']" on line 166, col 9
                    if _v is not None: write(_filter(_v, rawExpr="$itm['desc']")) # from line 166, col 9.
                    write('''
''')
                else: # generated from line 167, col 5
                    for line in VFFSL(SL,"itm",True)['desc']: # generated from line 168, col 9
                        write('''        ''')
...
''')
            write('''        return self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 174, col 22
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 174, col 22.
            write('''
    
    @''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 176, col 6
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 176, col 6.
            write('''.setter
    def ''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 177, col 9
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 177, col 9.
            write('''(self, value: ''')
            _v = VFFSL(SL,"itm",True)['type'] # "$itm['type']" on line 177, col 34
            if _v is not None: write(_filter(_v, rawExpr="$itm['type']")) # from line 177, col 34.
            write(''') -> None:
        self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 178, col 15
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 178, col 15.
            write(''' = value
''')
        write("""

__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 182, col 13
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 182, col 13.
        write("""']""")
