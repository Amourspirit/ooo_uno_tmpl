...
__CHEETAH_genTime__ = 1643917474.5410178
__CHEETAH_genTimestamp__ = 'Thu Feb  3 14:44:34 2022'
__CHEETAH_src__ = '_struct_base.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Feb  3 14:44:30 2022'
...
''')
        ...
        write('''    def __init__(self, *args, **kwargs):
        """
        Constructor
...
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 85, col 1
            ...
            write('''            ''')
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 91, col 13
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 91, col 13.
            write(''' (''')
            _v = VFFSL(SL,"itm_type",True) # '$itm_type' on line 91, col 24
            if _v is not None: write(_filter(_v, rawExpr='$itm_type')) # from line 91, col 24.
            write(''', optional): ''')
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 91, col 46
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 91, col 46.
            write(''' value
''')
        write('''        """
''')
...
''')
        write('''
        key_order = (''')
        _v = VFN(VFFSL(SL,"self",True),"get_nt_names_str",False)() # '$self.get_nt_names_str()' on line 101, col 22
        if _v is not None: write(_filter(_v, rawExpr='$self.get_nt_names_str()')) # from line 101, col 22.
        write(''')
        if len(args) > len(key_order):
            raise ValueError("''')
        _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 103, col 31
        if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 103, col 31.
...
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 110, col 1
            index = tpl[1]
    ...
    @property
    def ''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 116, col 9
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 116, col 9.
            write('''(self) -> ''')
            ...
            write(''':
''')
            if VFFSL(SL,"include_desc",True) and VFFSL(SL,"itm.lines",True): # generated from line 117, col 1
                write('''        """
''')
                if isinstance(VFFSL(SL,"itm.lines",True), str): # generated from line 119, col 5
                    write('''        ''')
                    ...
                    write('''
''')
                else: # generated from line 121, col 5
                    for line in VFFSL(SL,"itm.lines",True): # generated from line 122, col 9
                        write('''        ''')
...
''')
            write('''        return self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 128, col 22
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 128, col 22.
            write('''
    
    @''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 130, col 6
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 130, col 6.
            write('''.setter
    def ''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 131, col 9
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 131, col 9.
            write('''(self, value: ''')
            _v = VFFSL(SL,"itm.type",True) # '$itm.type' on line 131, col 34
            if _v is not None: write(_filter(_v, rawExpr='$itm.type')) # from line 131, col 34.
            write(''') -> None:
        self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 132, col 15
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 132, col 15.
            write(''' = value
''')
        write("""

__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 136, col 13
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 136, col 13.
        write("""']""")
