...
__CHEETAH_genTime__ = 1643227879.5388427
__CHEETAH_genTimestamp__ = 'Wed Jan 26 15:11:19 2022'
__CHEETAH_src__ = '_struct_base.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Jan 26 15:10:50 2022'
...
''')
            ...
            write('''
''')
        if VFFSL(SL,"dynamic_struct",True): # generated from line 112, col 1
            write('''
def _dynamic_struct():
    # Dynamically create nametuple that is more efficient as stand in for struct

    global ''')
            _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 117, col 12
            if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 117, col 12.
            write("""
    ...
    if not typing.TYPE_CHECKING:
        """)
            _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 123, col 9
            if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 123, col 9.
            write(""" = namedtuple('""")
            _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 123, col 36
            if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 123, col 36.
            write("""', [""")
            _v = VFN(VFFSL(SL,"self",True),"get_nt_names_str",False)() # '$self.get_nt_names_str()' on line 123, col 50
            if _v is not None: write(_filter(_v, rawExpr='$self.get_nt_names_str()')) # from line 123, col 50.
            write('''])
...
''')
        write("""
__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 129, col 13
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 129, col 13.
        write("""']""")
