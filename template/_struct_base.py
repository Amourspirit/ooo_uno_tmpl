...
__CHEETAH_genTime__ = 1643936506.9535134
__CHEETAH_genTimestamp__ = 'Thu Feb  3 20:01:46 2022'
__CHEETAH_src__ = '_struct_base.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Feb  3 19:51:07 2022'
...
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 87, col 1
            ...
            write('''            ''')
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 93, col 13
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 93, col 13.
            write(''' (''')
            _v = VFFSL(SL,"itm_type",True) # '$itm_type' on line 93, col 24
            if _v is not None: write(_filter(_v, rawExpr='$itm_type')) # from line 93, col 24.
            write(''', optional): ''')
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 93, col 46
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 93, col 46.
            write(''' value
''')
        write('''        """
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 96, col 1
            ...
            itm_name = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"itm.name",True))
            write('''        self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 100, col 15
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 100, col 15.
            write(''' = None
''')
        write('''
        key_order = (''')
        _v = VFN(VFFSL(SL,"self",True),"get_nt_names_str",False)() # '$self.get_nt_names_str()' on line 103, col 22
        if _v is not None: write(_filter(_v, rawExpr='$self.get_nt_names_str()')) # from line 103, col 22.
        write(''')
        if len(args) > len(key_order):
            raise ValueError("''')
        _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 105, col 31
        if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 105, col 31.
...
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 112, col 1
            index = tpl[1]
    ...
    @property
    def ''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 118, col 9
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 118, col 9.
            write('''(self) -> ''')
            _v = VFFSL(SL,"itm.type",True) # '$itm.type' on line 118, col 30
            if _v is not None: write(_filter(_v, rawExpr='$itm.type')) # from line 118, col 30.
            write(''':
''')
            if VFFSL(SL,"include_desc",True) and VFFSL(SL,"itm.lines",True): # generated from line 119, col 1
                write('''        """
''')
                if isinstance(VFFSL(SL,"itm.lines",True), str): # generated from line 121, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"itm.lines",True) # '$itm.lines' on line 122, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$itm.lines')) # from line 122, col 9.
                    write('''
''')
                else: # generated from line 123, col 5
                    for line in VFFSL(SL,"itm.lines",True): # generated from line 124, col 9
                        write('''        ''')
                        _v = VFFSL(SL,"line",True) # '$line' on line 125, col 9
                        if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 125, col 9.
                        write('''
''')
                write('''        """
''')
            write('''        return self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 130, col 22
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 130, col 22.
            write('''
    
    @''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 132, col 6
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 132, col 6.
            write('''.setter
    def ''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 133, col 9
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 133, col 9.
            write('''(self, value: ''')
            _v = VFFSL(SL,"itm.type",True) # '$itm.type' on line 133, col 34
            if _v is not None: write(_filter(_v, rawExpr='$itm.type')) # from line 133, col 34.
            write(''') -> None:
        self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 134, col 15
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 134, col 15.
            write(''' = value
''')
        write("""

__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 138, col 13
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 138, col 13.
        write("""']""")
