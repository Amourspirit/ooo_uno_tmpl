...
__CHEETAH_genTime__ = 1644616762.165865
__CHEETAH_genTimestamp__ = 'Fri Feb 11 16:59:22 2022'
__CHEETAH_src__ = '_struct_base.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Feb 11 16:59:17 2022'
...
''')
        ...
        write('''    ''')
        _v = VFN(VFFSL(SL,"self",True),"get_constructor",False)() # '$self.get_constructor()' on line 89, col 5
        if _v is not None: write(_filter(_v, rawExpr='$self.get_constructor()')) # from line 89, col 5.
        write('''
        """
        Constructor
...
''')
        ...
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 109, col 51
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 109, col 51.
        write('''):
            oth: ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 110, col 18
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 110, col 18.
        write(''' = args[0]
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 111, col 1
            ...
            write(''' = oth.''')
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 116, col 57
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 116, col 57.
            write('''
''')
        write('''        else:
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 119, col 1
            index = tpl[1]
            itm = VFFSL(SL,"attribs",True)[VFFSL(SL,"index",True)]
            itm_name = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"itm.name",True))
            attrib_default = VFN(VFFSL(SL,"self",True),"get_attrib_default",False)(VFFSL(SL,"itm",True), True)
            if attrib_default == 'UNO_NONE': # generated from line 124, col 5
                write('''            if ''')
                _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 125, col 16
                if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 125, col 16.
                write(''' is UNO_NONE:
                self._''')
                _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 126, col 23
                if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 126, col 23.
                write(''' = ''')
                _v = VFN(VFFSL(SL,"self",True),"get_attrib_default",False)(VFFSL(SL,"itm",True)) # '$self.get_attrib_default($itm)' on line 126, col 57
                if _v is not None: write(_filter(_v, rawExpr='$self.get_attrib_default($itm)')) # from line 126, col 57.
                write('''
            else:
                self._''')
                _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 128, col 23
                if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 128, col 23.
                write(''' = ''')
                _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 128, col 57
                if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 128, col 57.
                write('''
''')
            else: # generated from line 129, col 5
                write('''            self._''')
                _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 130, col 19
                if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 130, col 19.
                write(''' = ''')
                _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 130, col 53
                if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 130, col 53.
                write('''
''')
        if VFN(VFFSL(SL,"self",True),"has_uno_extends",False)(): # generated from line 133, col 1
            write('''
        super().__init__(*args, **kwargs)
''')
        write('''
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 138, col 1
            index = tpl[1]
    ...
    @property
    def ''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 144, col 9
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 144, col 9.
            write('''(self) -> ''')
            _v = VFFSL(SL,"itm",True)['type'] # "$itm['type']" on line 144, col 30
            if _v is not None: write(_filter(_v, rawExpr="$itm['type']")) # from line 144, col 30.
            write(''':
''')
            if VFFSL(SL,"include_desc",True) and VFFSL(SL,"itm",True)['lines']: # generated from line 145, col 1
                write('''        """
''')
                if isinstance(VFFSL(SL,"itm",True)['lines'], str): # generated from line 147, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"itm.lines",True) # '$itm.lines' on line 148, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$itm.lines')) # from line 148, col 9.
                    write('''
''')
                else: # generated from line 149, col 5
                    for line in VFFSL(SL,"itm",True)['lines']: # generated from line 150, col 9
                        write('''        ''')
...
''')
            write('''        return self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 156, col 22
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 156, col 22.
            write('''
    
    @''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 158, col 6
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 158, col 6.
            write('''.setter
    def ''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 159, col 9
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 159, col 9.
            write('''(self, value: ''')
            _v = VFFSL(SL,"itm",True)['type'] # "$itm['type']" on line 159, col 34
            if _v is not None: write(_filter(_v, rawExpr="$itm['type']")) # from line 159, col 34.
            write(''') -> None:
        self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 160, col 15
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 160, col 15.
            write(''' = value
''')
        write("""
