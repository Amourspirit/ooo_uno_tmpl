...
__CHEETAH_genTime__ = 1644362486.318864
__CHEETAH_genTimestamp__ = 'Tue Feb  8 18:21:26 2022'
__CHEETAH_src__ = '_struct_base.tmpl'
__CHEETAH_srcLastModified__ = 'Tue Feb  8 18:21:22 2022'
...
''')
        if VFFSL(SL,"is_properties",True): # generated from line 149, col 1
            ...
            for property in VFFSL(SL,"properties",True): # generated from line 151, col 1
                ...
                write('''    @property
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 156, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 156, col 9.
                write('''(self) -> ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 156, col 28
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 156, col 28.
                write(''':
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 158, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 159, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 159, col 9.
                    write('''
''')
                write('''        """
        return self._''')
                _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"p_name",True)) # '$self.camel_to_snake($p_name)' on line 162, col 22
                if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($p_name)')) # from line 162, col 22.
                write('''
    ...
    def ''')
                ...
                write(''') -> None:
        self._''')
                _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"p_name",True)) # '$self.camel_to_snake($p_name)' on line 166, col 15
                if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($p_name)')) # from line 166, col 15.
                write(''' = value
''')
        write("""
...
__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 172, col 13
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 172, col 13.
        write("""']""")
