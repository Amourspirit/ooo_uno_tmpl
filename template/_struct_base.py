...
__CHEETAH_genTime__ = 1644005985.2347093
__CHEETAH_genTimestamp__ = 'Fri Feb  4 15:19:45 2022'
__CHEETAH_src__ = '_struct_base.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Feb  4 15:19:11 2022'
...
''')
        ...
        write("""    typeName: str = '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 79, col 22
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 79, col 22.
        write('''\'
    """Literal Constant ``''')
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 80, col 27
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 80, col 27.
        write('''``"""
    ...
    def __init__(self, *args, **kwargs):
        ...
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 87, col 50
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 87, col 50.
        write('''`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 89, col 67
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 89, col 67.
        write('''``
...
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 93, col 1
            ...
            write('''            ''')
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 99, col 13
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 99, col 13.
            write(''' (''')
            _v = VFFSL(SL,"itm_type",True) # '$itm_type' on line 99, col 24
            if _v is not None: write(_filter(_v, rawExpr='$itm_type')) # from line 99, col 24.
            write(''', optional): ''')
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 99, col 46
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 99, col 46.
            write(''' value
''')
        write('''        """
''')
...
''')
        write('''
        key_order = (''')
        _v = VFN(VFFSL(SL,"self",True),"get_nt_names_str",False)() # '$self.get_nt_names_str()' on line 109, col 22
        if _v is not None: write(_filter(_v, rawExpr='$self.get_nt_names_str()')) # from line 109, col 22.
        write(''')
        if len(args) > len(key_order):
            raise ValueError("''')
        _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 111, col 31
        if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 111, col 31.
...
''')
    ...
    @property
    def ''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 124, col 9
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 124, col 9.
            write('''(self) -> ''')
            _v = VFFSL(SL,"itm.type",True) # '$itm.type' on line 124, col 30
            if _v is not None: write(_filter(_v, rawExpr='$itm.type')) # from line 124, col 30.
            write(''':
''')
            if VFFSL(SL,"include_desc",True) and VFFSL(SL,"itm.lines",True): # generated from line 125, col 1
                write('''        """
''')
                if isinstance(VFFSL(SL,"itm.lines",True), str): # generated from line 127, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"itm.lines",True) # '$itm.lines' on line 128, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$itm.lines')) # from line 128, col 9.
                    write('''
''')
                else: # generated from line 129, col 5
                    for line in VFFSL(SL,"itm.lines",True): # generated from line 130, col 9
                        write('''        ''')
...
''')
            write('''        return self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 136, col 22
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 136, col 22.
            write('''
    
    @''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 138, col 6
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 138, col 6.
            write('''.setter
    def ''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 139, col 9
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 139, col 9.
            write('''(self, value: ''')
            _v = VFFSL(SL,"itm.type",True) # '$itm.type' on line 139, col 34
            if _v is not None: write(_filter(_v, rawExpr='$itm.type')) # from line 139, col 34.
            write(''') -> None:
        self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 140, col 15
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 140, col 15.
            write(''' = value
''')
        write("""

__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 144, col 13
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 144, col 13.
        write("""']""")
