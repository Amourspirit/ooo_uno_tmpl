...
__CHEETAH_genTime__ = 1644009758.7806525
__CHEETAH_genTimestamp__ = 'Fri Feb  4 16:22:38 2022'
__CHEETAH_src__ = '_struct_base.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Feb  4 16:22:09 2022'
...
''')
        ...
        if  arg_len > len(key_order):
            raise ValueError("''')
        _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 119, col 31
        if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 119, col 31.
...
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 126, col 1
            index = tpl[1]
    ...
    @property
    def ''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 132, col 9
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 132, col 9.
            write('''(self) -> ''')
            _v = VFFSL(SL,"itm.type",True) # '$itm.type' on line 132, col 30
            if _v is not None: write(_filter(_v, rawExpr='$itm.type')) # from line 132, col 30.
            write(''':
''')
            if VFFSL(SL,"include_desc",True) and VFFSL(SL,"itm.lines",True): # generated from line 133, col 1
                write('''        """
''')
                if isinstance(VFFSL(SL,"itm.lines",True), str): # generated from line 135, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"itm.lines",True) # '$itm.lines' on line 136, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$itm.lines')) # from line 136, col 9.
                    write('''
''')
                else: # generated from line 137, col 5
                    for line in VFFSL(SL,"itm.lines",True): # generated from line 138, col 9
                        write('''        ''')
...
''')
            write('''        return self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 144, col 22
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 144, col 22.
            write('''
    
    @''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 146, col 6
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 146, col 6.
            write('''.setter
    def ''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 147, col 9
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 147, col 9.
            write('''(self, value: ''')
            _v = VFFSL(SL,"itm.type",True) # '$itm.type' on line 147, col 34
            if _v is not None: write(_filter(_v, rawExpr='$itm.type')) # from line 147, col 34.
            write(''') -> None:
        self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 148, col 15
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 148, col 15.
            write(''' = value
''')
        write("""

__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 152, col 13
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 152, col 13.
        write("""']""")
