...
__CHEETAH_genTime__ = 1640896796.8561769
__CHEETAH_genTimestamp__ = 'Thu Dec 30 15:39:56 2021'
__CHEETAH_src__ = '_struct_base.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Dec 30 15:38:43 2021'
...
''')
        if VFFSL(SL,"dynamic_struct",True): # generated from line 30, col 1
            write('''import os
...
''')
        for frm, imp in VFFSL(SL,"from_imports",True): # generated from line 37, col 1
            ...
            write('''
''')
        if VFFSL(SL,"requires_typing",True) or VFFSL(SL,"dynamic_struct",True): # generated from line 40, col 1
            write('''import typing
''')
...
class ''')
        ...
        write('''(''')
        _v = VFFSL(SL,"str_inherits",True) # '${str_inherits}' on line 51, col 20
        if _v is not None: write(_filter(_v, rawExpr='${str_inherits}')) # from line 51, col 20.
        write('''):
    """
''')
...
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 74, col 1
            ...
            write('''        self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 78, col 15
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 78, col 15.
            write(''' = ''')
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 78, col 49
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 78, col 49.
            write('''
''')
    ...
    @property
    def ''')
            _v = VFFSL(SL,"itm_name",True) # '${itm_name}' on line 86, col 9
            if _v is not None: write(_filter(_v, rawExpr='${itm_name}')) # from line 86, col 9.
            write('''(self) -> ''')
            _v = VFFSL(SL,"itm.type",True) # '$itm.type' on line 86, col 30
            if _v is not None: write(_filter(_v, rawExpr='$itm.type')) # from line 86, col 30.
            write(''':
''')
            if VFFSL(SL,"itm.lines",True): # generated from line 87, col 5
                write('''        """
''')
                if isinstance(VFFSL(SL,"itm.lines",True), str): # generated from line 89, col 9
                    write('''        ''')
                    _v = VFFSL(SL,"itm.lines",True) # '$itm.lines' on line 90, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$itm.lines')) # from line 90, col 9.
                    write('''
''')
                else: # generated from line 91, col 9
                    for line in VFFSL(SL,"itm.lines",True): # generated from line 92, col 13
                        write('''        ''')
...
''')
            write('''        return self._''')
            _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 98, col 22
            if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 98, col 22.
            write('''
''')
...
def _dynamic_struct():
    ...
    global ''')
            _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 105, col 12
            if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 105, col 12.
            write("""
    ...
    if not typing.TYPE_CHECKING:
        """)
            _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 111, col 9
            if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 111, col 9.
            write(""" = namedtuple('""")
            _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 111, col 36
            if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 111, col 36.
            write("""', [""")
            _v = VFN(VFFSL(SL,"self",True),"get_nt_names_str",False)() # '$self.get_nt_names_str()' on line 111, col 50
            if _v is not None: write(_filter(_v, rawExpr='$self.get_nt_names_str()')) # from line 111, col 50.
            write('''])
