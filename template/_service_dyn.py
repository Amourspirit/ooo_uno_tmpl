...
__CHEETAH_genTime__ = 1643849919.5876293
__CHEETAH_genTimestamp__ = 'Wed Feb  2 19:58:39 2022'
__CHEETAH_src__ = '_service_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Feb  2 19:58:29 2022'
...
def create_service(ctx: 'Optional[XComponentContext]' = None, args: Optional[Iterable[object]] = None) -> Union[""")
    ...
    return uno_helper.create_uno_service(cClass=\'''')
        _v = VFFSL(SL,"full_name",True) # '${full_name}' on line 57, col 50
        if _v is not None: write(_filter(_v, rawExpr='${full_name}')) # from line 57, col 50.
