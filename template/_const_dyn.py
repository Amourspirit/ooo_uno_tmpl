...
__CHEETAH_genTime__ = 1656880289.8265746
__CHEETAH_genTimestamp__ = 'Sun Jul  3 16:31:29 2022'
__CHEETAH_src__ = '_const_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Sun Jul  3 16:31:25 2022'
...
''')
        for item in VFFSL(SL,"attribs",True): # generated from line 78, col 5
            ...
            write('''        ''')
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"item",True)['name']) # "$self.get_safe_word($item['name'])" on line 83, col 9
            if _v is not None: write(_filter(_v, rawExpr="$self.get_safe_word($item['name'])")) # from line 83, col 9.
            write(''' = ''')
            _v = VFN(VFFSL(SL,"self",True),"get_q_type",False)(VFFSL(SL,"item",True)['value']) # "$self.get_q_type($item['value'])" on line 83, col 46
            if _v is not None: write(_filter(_v, rawExpr="$self.get_q_type($item['value'])")) # from line 83, col 46.
            write('''
''')
            if len(VFFSL(SL,"item",True)['lines']) > 0: # generated from line 84, col 9
                write('''        """
''')
                if isinstance(VFFSL(SL,"item",True)['lines'], str): # generated from line 86, col 13
                    write('''        ''')
                    _v = VFFSL(SL,"item",True)['lines'] # "$item['lines']" on line 87, col 9
                    if _v is not None: write(_filter(_v, rawExpr="$item['lines']")) # from line 87, col 9.
                    write('''
''')
                else: # generated from line 88, col 13
                    for line in VFFSL(SL,"item",True)['lines']: # generated from line 89, col 17
                        write('''        ''')
...
__all__ = ['""")
        ...
        write("""', '""")
        _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 97, col 29
        if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 97, col 29.
        write("""Enum']""")
