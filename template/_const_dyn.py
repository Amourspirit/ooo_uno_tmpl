...
__CHEETAH_genTime__ = 1684204636.5569305
__CHEETAH_genTimestamp__ = 'Mon May 15 22:37:16 2023'
__CHEETAH_src__ = '_const_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Mon May 15 22:37:07 2023'
...
''')
    ...
    from ''')
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 64, col 10
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 64, col 10.
        write(''' import ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 64, col 28
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 64, col 28.
        write(''' as ''')
