...
__CHEETAH_genTime__ = 1644091363.0202775
__CHEETAH_genTimestamp__ = 'Sat Feb  5 15:02:43 2022'
__CHEETAH_src__ = '_typedef_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Feb  5 15:01:15 2022'
...
''')
        write('''
''')
        _v = VFN(VFFSL(SL,"self",True),"get_rel_import",False)(in_str=VFFSL(SL,"uno_obj_in",True), ns=VFFSL(SL,"uno_obj_ns",True)) # '$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)' on line 35, col 1
        if _v is not None: write(_filter(_v, rawExpr='$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)')) # from line 35, col 1.
        write(''' as ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 35, col 61
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 35, col 61.
        write('''
''')
