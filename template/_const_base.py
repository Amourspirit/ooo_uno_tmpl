...
__CHEETAH_genTime__ = 1639048018.7302456
__CHEETAH_genTimestamp__ = 'Thu Dec  9 06:06:58 2021'
__CHEETAH_src__ = '_const_base.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Dec  9 06:06:45 2021'
...
''')
        ...
        _v = VFFSL(SL,"base_class",True) # '$base_class' on line 34, col 27
        if _v is not None: write(_filter(_v, rawExpr='$base_class')) # from line 34, col 27.
        write('''
...
''')
        write('''    """
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 52, col 1
            value = VFFSL(SL,"const_dict",True)[VFFSL(SL,"key",True)]
            if VFFSL(SL,"hex",True): # generated from line 54, col 5
                write('''    ''')
                _v = VFFSL(SL,"key",True) # '$key' on line 55, col 5
                if _v is not None: write(_filter(_v, rawExpr='$key')) # from line 55, col 5.
                write(""" = int('""")
                _v = VFFSL(SL,"value",True)[0] # '${value[0]}' on line 55, col 17
                if _v is not None: write(_filter(_v, rawExpr='${value[0]}')) # from line 55, col 17.
                write("""', 16)
""")
                ...
                write(''' = ''')
                _v = VFFSL(SL,"value",True)[0] # '$value[0]' on line 57, col 12
                if _v is not None: write(_filter(_v, rawExpr='$value[0]')) # from line 57, col 12.
                write('''
''')
            if len(VFFSL(SL,"value",True)) > 1: # generated from line 59, col 5
                write('''    """
''')
                if isinstance(VFFSL(SL,"value",True)[1], str): # generated from line 61, col 9
                    write('''    ''')
                    _v = VFFSL(SL,"value",True)[1] # '${$value[1]}' on line 62, col 5
                    if _v is not None: write(_filter(_v, rawExpr='${$value[1]}')) # from line 62, col 5.
                    write('''
''')
                else: # generated from line 63, col 9
                    for line in VFFSL(SL,"value",True)[1]: # generated from line 64, col 13
                        write('''    ''')
