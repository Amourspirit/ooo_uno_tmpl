...
__CHEETAH_genTime__ = 1640704929.1731029
__CHEETAH_genTimestamp__ = 'Tue Dec 28 10:22:09 2021'
__CHEETAH_src__ = '_const_base.tmpl'
__CHEETAH_srcLastModified__ = 'Tue Dec 28 10:22:06 2021'
...
''')
        for frm, imp in VFFSL(SL,"from_imports",True): # generated from line 28, col 1
            ...
            write('''
''')
        for frm, imp in VFFSL(SL,"from_typing_imports",True): # generated from line 31, col 1
            write('''from ''')
...
""")
                ...
                write(''' = ''')
                _v = VFN(VFFSL(SL,"self",True),"get_q_type",False)(VFFSL(SL,"value",True)[0]) # '$self.get_q_type($value[0])' on line 56, col 12
                if _v is not None: write(_filter(_v, rawExpr='$self.get_q_type($value[0])')) # from line 56, col 12.
                write('''
''')
