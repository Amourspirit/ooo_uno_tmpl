...
__CHEETAH_genTime__ = 1643227878.9855967
__CHEETAH_genTimestamp__ = 'Wed Jan 26 15:11:18 2022'
__CHEETAH_src__ = '_const_base.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Jan 26 15:10:12 2022'
...
''')
        if VFFSL(SL,"libre_office_ver",True): # generated from line 26, col 1
            write('''# Libre Office Version: ''')
            _v = VFFSL(SL,"libre_office_ver",True) # '$libre_office_ver' on line 27, col 25
            if _v is not None: write(_filter(_v, rawExpr='$libre_office_ver')) # from line 27, col 25.
            write('''
# Namespace: ''')
            _v = VFFSL(SL,"namespace",True) # '$namespace' on line 28, col 14
            if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 28, col 14.
            write('''
''')
...
''')
        for frm, imp in VFFSL(SL,"from_imports",True): # generated from line 36, col 1
            ...
            write('''
''')
        for frm, imp in VFFSL(SL,"from_typing_imports",True): # generated from line 39, col 1
            write('''from ''')
...
class ''')
        _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"name",True)) # '$self.get_safe_word($name)' on line 44, col 7
        if _v is not None: write(_filter(_v, rawExpr='$self.get_safe_word($name)')) # from line 44, col 7.
        write('''(''')
        _v = VFFSL(SL,"base_class",True) # '$base_class' on line 44, col 34
        if _v is not None: write(_filter(_v, rawExpr='$base_class')) # from line 44, col 34.
        write('''):
    """
''')
...
''')
        write('''    """
''')
        for item in VFFSL(SL,"attribs",True): # generated from line 59, col 1
            write('''    ''')
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"item",True)['name']) # "$self.get_safe_word($item['name'])" on line 60, col 5
            if _v is not None: write(_filter(_v, rawExpr="$self.get_safe_word($item['name'])")) # from line 60, col 5.
            write(''' = ''')
            _v = VFN(VFFSL(SL,"self",True),"get_q_type",False)(VFFSL(SL,"item",True)['value']) # "$self.get_q_type($item['value'])" on line 60, col 42
            if _v is not None: write(_filter(_v, rawExpr="$self.get_q_type($item['value'])")) # from line 60, col 42.
            write('''
''')
            if len(VFFSL(SL,"item",True)['lines']) > 0: # generated from line 61, col 5
                write('''    """
''')
                if isinstance(VFFSL(SL,"item",True)['lines'], str): # generated from line 63, col 9
                    write('''    ''')
                    _v = VFFSL(SL,"item",True)['lines'] # "$item['lines']" on line 64, col 5
                    if _v is not None: write(_filter(_v, rawExpr="$item['lines']")) # from line 64, col 5.
                    write('''
''')
                else: # generated from line 65, col 9
                    for line in VFFSL(SL,"item",True)['lines']: # generated from line 66, col 13
                        write('''    ''')
