...
__CHEETAH_genTime__ = 1640970892.5133457
__CHEETAH_genTimestamp__ = 'Fri Dec 31 12:14:52 2021'
__CHEETAH_src__ = '_const_base.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Dec 31 11:59:37 2021'
...
class ''')
        _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"name",True)) # '$self.get_safe_word($name)' on line 37, col 7
        if _v is not None: write(_filter(_v, rawExpr='$self.get_safe_word($name)')) # from line 37, col 7.
        write('''(''')
        _v = VFFSL(SL,"base_class",True) # '$base_class' on line 37, col 34
        if _v is not None: write(_filter(_v, rawExpr='$base_class')) # from line 37, col 34.
        write('''):
    """
''')
...
''')
        for item in VFFSL(SL,"attribs",True): # generated from line 52, col 1
            write('''    ''')
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"item",True)['name']) # "$self.get_safe_word($item['name'])" on line 53, col 5
            if _v is not None: write(_filter(_v, rawExpr="$self.get_safe_word($item['name'])")) # from line 53, col 5.
            write(''' = ''')
            _v = VFN(VFFSL(SL,"self",True),"get_q_type",False)(VFFSL(SL,"item",True)['value']) # "$self.get_q_type($item['value'])" on line 53, col 42
            if _v is not None: write(_filter(_v, rawExpr="$self.get_q_type($item['value'])")) # from line 53, col 42.
            write('''
''')
