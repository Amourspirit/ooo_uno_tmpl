...
__CHEETAH_genTime__ = 1640870803.7757046
__CHEETAH_genTimestamp__ = 'Thu Dec 30 08:26:43 2021'
__CHEETAH_src__ = '_const_base.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Dec 30 08:26:40 2021'
...
''')
        for item in VFFSL(SL,"attribs",True): # generated from line 52, col 1
            write('''    ''')
            _v = VFFSL(SL,"item",True)['name'] # "$item['name']" on line 53, col 5
            if _v is not None: write(_filter(_v, rawExpr="$item['name']")) # from line 53, col 5.
            write(''' = ''')
            _v = VFN(VFFSL(SL,"self",True),"get_q_type",False)(VFFSL(SL,"item",True)['value']) # "$self.get_q_type($item['value'])" on line 53, col 21
            if _v is not None: write(_filter(_v, rawExpr="$self.get_q_type($item['value'])")) # from line 53, col 21.
            write('''
''')
