...
__CHEETAH_genTime__ = 1641067869.3991792
__CHEETAH_genTimestamp__ = 'Sat Jan  1 15:11:09 2022'
__CHEETAH_src__ = '_const_base.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Jan  1 15:10:49 2022'
...
# Generated: ''')
        _v = VFN(VFFSL(SL,"self",True),"get_timestamp_utc",False)() # '$self.get_timestamp_utc()' on line 24, col 14
        if _v is not None: write(_filter(_v, rawExpr='$self.get_timestamp_utc()')) # from line 24, col 14.
        write('''
''')
...
''')
        for frm, imp in VFFSL(SL,"from_imports",True): # generated from line 31, col 1
            ...
            write('''
''')
        for frm, imp in VFFSL(SL,"from_typing_imports",True): # generated from line 34, col 1
            write('''from ''')
...
class ''')
        _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"name",True)) # '$self.get_safe_word($name)' on line 39, col 7
        if _v is not None: write(_filter(_v, rawExpr='$self.get_safe_word($name)')) # from line 39, col 7.
        write('''(''')
        _v = VFFSL(SL,"base_class",True) # '$base_class' on line 39, col 34
        if _v is not None: write(_filter(_v, rawExpr='$base_class')) # from line 39, col 34.
        write('''):
    """
''')
...
''')
        for item in VFFSL(SL,"attribs",True): # generated from line 54, col 1
            ...
            write(''' = ''')
            _v = VFN(VFFSL(SL,"self",True),"get_q_type",False)(VFFSL(SL,"item",True)['value']) # "$self.get_q_type($item['value'])" on line 55, col 42
            if _v is not None: write(_filter(_v, rawExpr="$self.get_q_type($item['value'])")) # from line 55, col 42.
            write('''
''')
