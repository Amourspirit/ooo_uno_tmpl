...
__CHEETAH_genTime__ = 1644353575.8292365
...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_singleton() -> None:
        ...
        write('''\'
            ...
            return singleton
        ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 75, col 9
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 75, col 9.
