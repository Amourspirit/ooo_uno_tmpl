...
__CHEETAH_genTime__ = 1643911243.4623392
__CHEETAH_genTimestamp__ = 'Thu Feb  3 13:00:43 2022'
__CHEETAH_src__ = '_singleton_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Feb  3 13:00:39 2022'
...
class singleton_dyn(BaseSingletonDyn):
    ...
    def respond(self, trans=None):
        ...
        name_value = '/singletons/' + VFFSL(SL,"full_name",True) + '/service'
        # 
...
''')
        if VFFSL(SL,"libre_office_ver",True): # generated from line 49, col 1
            write('''# Libre Office Version: ''')
            _v = VFFSL(SL,"libre_office_ver",True) # '$libre_office_ver' on line 50, col 25
            if _v is not None: write(_filter(_v, rawExpr='$libre_office_ver')) # from line 50, col 25.
            write('''
''')
        write('''# Namespace: ''')
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 52, col 14
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 52, col 14.
        write('''
...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_singleton() -> None:
        ...
        import uno
        global ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 64, col 16
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 64, col 16.
        write("""

        def _singleton_init():
            ctx = uno.getComponentContext()
            key = '""")
        _v = VFFSL(SL,"name_value",True) # '$name_value' on line 68, col 20
        if _v is not None: write(_filter(_v, rawExpr='$name_value')) # from line 68, col 20.
        write('''\'
