...
__CHEETAH_genTime__ = 1684876125.7264457
__CHEETAH_genTimestamp__ = 'Tue May 23 17:08:45 2023'
__CHEETAH_src__ = '_struct_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Tue May 23 17:06:24 2023'
...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    if TYPE_CHECKING:
        from ''')
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 73, col 14
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 73, col 14.
        write(''' import ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 73, col 32
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 73, col 32.
        write(''' as ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 73, col 46
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 73, col 46.
        write('''
    else:
