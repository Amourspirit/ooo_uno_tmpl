...
__CHEETAH_genTime__ = 1644749784.4800594
__CHEETAH_genTimestamp__ = 'Sun Feb 13 05:56:24 2022'
__CHEETAH_src__ = '_struct_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Sun Feb 13 05:56:19 2022'
...
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 71, col 1
            ...
            write(""" is UNO_NONE:
                if getattr(struct, '""")
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 77, col 37
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 77, col 37.
            write("""') != """)
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 77, col 52
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 77, col 52.
            write(""":
                    setattr(struct, '""")
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 78, col 38
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 78, col 38.
            write("""', """)
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 78, col 50
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 78, col 50.
            write(''')
''')
