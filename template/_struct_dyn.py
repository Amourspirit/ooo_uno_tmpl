...
__CHEETAH_genTime__ = 1644748661.6999745
__CHEETAH_genTimestamp__ = 'Sun Feb 13 05:37:41 2022'
__CHEETAH_src__ = '_struct_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Sun Feb 13 05:37:22 2022'
...
''')
    ...
    ''')
        _v = VFN(VFFSL(SL,"self",True),"get_rel_import",False)(in_str=VFFSL(SL,"uno_obj_in",True), ns=VFFSL(SL,"uno_obj_ns",True)) # '$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)' on line 88, col 5
        if _v is not None: write(_filter(_v, rawExpr='$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)')) # from line 88, col 5.
        write(''' as ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 88, col 65
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 88, col 65.
        write("""

__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 90, col 13
        if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 90, col 13.
        write("""']
""")
