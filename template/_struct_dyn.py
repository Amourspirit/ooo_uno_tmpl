...
__CHEETAH_genTime__ = 1643849311.5524647
__CHEETAH_genTimestamp__ = 'Wed Feb  2 19:48:31 2022'
__CHEETAH_src__ = '_struct_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Feb  2 19:48:27 2022'
...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    def _dynamic_struct() -> None:
        ...
        write('''
        order = (''')
        _v = VFN(VFFSL(SL,"self",True),"get_nt_names_str",False)() # '$self.get_nt_names_str()' on line 51, col 18
        if _v is not None: write(_filter(_v, rawExpr='$self.get_nt_names_str()')) # from line 51, col 18.
        write(""")
        ...
        write("""')
            ...
            return struct
        """)
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 62, col 9
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 62, col 9.
        write(''' = _struct_init

    _dynamic_struct()
else:
    ''')
        _v = VFN(VFFSL(SL,"self",True),"get_rel_import",False)(in_str=VFFSL(SL,"uno_obj_in",True), ns=VFFSL(SL,"uno_obj_ns",True)) # '$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)' on line 66, col 5
        if _v is not None: write(_filter(_v, rawExpr='$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)')) # from line 66, col 5.
        write(''' as ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 66, col 65
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 66, col 65.
        write("""

__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 68, col 13
        if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 68, col 13.
        write("""']
""")
