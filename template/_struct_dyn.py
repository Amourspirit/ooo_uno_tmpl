...
__CHEETAH_genTime__ = 1643917699.2787507
__CHEETAH_genTimestamp__ = 'Thu Feb  3 14:48:19 2022'
__CHEETAH_src__ = '_struct_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Feb  3 14:48:05 2022'
...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    def _dynamic_struct() -> None:
        ...
        _v = VFFSL(SL,"full_name",True) # '${full_name}' on line 54, col 52
        if _v is not None: write(_filter(_v, rawExpr='${full_name}')) # from line 54, col 52.
        write('''\')
            if len(args) > len(key_order):
                raise ValueError("''')
        _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 56, col 35
        if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 56, col 35.
        write('''.__init__() To many parameters")
            ...
            return struct
        ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 63, col 9
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 63, col 9.
        write(''' = _struct_init

    _dynamic_struct()
else:
    ''')
        _v = VFN(VFFSL(SL,"self",True),"get_rel_import",False)(in_str=VFFSL(SL,"uno_obj_in",True), ns=VFFSL(SL,"uno_obj_ns",True)) # '$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)' on line 67, col 5
        if _v is not None: write(_filter(_v, rawExpr='$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)')) # from line 67, col 5.
        write(''' as ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 67, col 65
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 67, col 65.
        write("""
