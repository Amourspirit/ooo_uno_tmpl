...
__CHEETAH_genTime__ = 1684711141.8976834
__CHEETAH_genTimestamp__ = 'Sun May 21 19:19:01 2023'
__CHEETAH_src__ = '_struct_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Sun May 21 19:18:58 2023'
...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    if TYPE_CHECKING:
        ...
        from ''')
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 74, col 14
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 74, col 14.
        write(''' import ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 74, col 32
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 74, col 32.
        write(''' as ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 74, col 46
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 74, col 46.
        write('''
    else:
        ''')
        _v = VFN(VFFSL(SL,"self",True),"get_rel_import",False)(in_str=VFFSL(SL,"uno_obj_in",True), ns=VFFSL(SL,"uno_obj_ns",True)) # '$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)' on line 76, col 9
        if _v is not None: write(_filter(_v, rawExpr='$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)')) # from line 76, col 9.
        write(''' as ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 76, col 69
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 76, col 69.
        write("""
