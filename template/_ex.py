...
__CHEETAH_genTime__ = 1643938049.9744017
__CHEETAH_genTimestamp__ = 'Thu Feb  3 20:27:29 2022'
__CHEETAH_src__ = '_ex.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Feb  3 20:27:19 2022'
...
''')
        write("""    typeName: str = '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 76, col 22
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 76, col 22.
        write('''\'
    """Literal Constant ``''')
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 77, col 27
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 77, col 27.
        write('''``"""

    __pyunointerface__: str = typeName
    __pyunostruct__: str = typeName
...
''')
        if VFFSL(SL,"is_properties",True): # generated from line 110, col 1
            ...
            for property in VFFSL(SL,"properties",True): # generated from line 112, col 1
                ...
                write('''    ''')
                _v = VFFSL(SL,"p_name",True) # '$p_name' on line 116, col 5
                if _v is not None: write(_filter(_v, rawExpr='$p_name')) # from line 116, col 5.
                write(''': ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 116, col 14
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 116, col 14.
                write(''' = None
    """
''')
...
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_get_raises",False)(VFFSL(SL,"property",True)): # generated from line 125, col 5
                        write('''        ''')
                        _v = VFFSL(SL,"long",True) # '$long' on line 126, col 9
                        if _v is not None: write(_filter(_v, rawExpr='$long')) # from line 126, col 9.
                        write(''': get raises ``''')
                        _v = VFFSL(SL,"short",True) # '$short' on line 126, col 29
                        if _v is not None: write(_filter(_v, rawExpr='$short')) # from line 126, col 29.
                        write('''``
''')
...
''')
        if VFFSL(SL,"is_types",True): # generated from line 136, col 1
            ...
            for property in VFFSL(SL,"properties",True): # generated from line 138, col 1
                ...
                p_desc = VFFSL(SL,"property",True)['desc']
                write('''    ''')
                _v = VFFSL(SL,"p_name",True) # '$p_name' on line 142, col 5
                if _v is not None: write(_filter(_v, rawExpr='$p_name')) # from line 142, col 5.
                write(''': ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 142, col 14
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 142, col 14.
                write(''' = None
    """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 144, col 5
                    write('''    ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 145, col 5
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 145, col 5.
                    write('''
''')
...
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_get_raises",False)(VFFSL(SL,"property",True)): # generated from line 151, col 5
                        write('''        ''')
                        _v = VFFSL(SL,"long",True) # '$long' on line 152, col 9
                        if _v is not None: write(_filter(_v, rawExpr='$long')) # from line 152, col 9.
                        write(''': get raises ``''')
                        _v = VFFSL(SL,"short",True) # '$short' on line 152, col 29
                        if _v is not None: write(_filter(_v, rawExpr='$short')) # from line 152, col 29.
                        write('''``
''')
