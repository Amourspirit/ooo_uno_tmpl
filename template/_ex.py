...
__CHEETAH_genTime__ = 1640647022.7715788
__CHEETAH_genTimestamp__ = 'Mon Dec 27 18:17:02 2021'
__CHEETAH_src__ = '_ex.tmpl'
__CHEETAH_srcLastModified__ = 'Mon Dec 27 18:11:19 2021'
...
''')
        if VFFSL(SL,"is_properties",True): # generated from line 55, col 1
            ...
            for property in VFFSL(SL,"properties",True): # generated from line 57, col 1
                ...
                p_type = VFN(VFFSL(SL,"self",True),"get_q_type",False)(VFFSL(SL,"property",True)['type'])
                ...
                write(''': ''')
                _v = VFFSL(SL,"p_type",True) # '$p_type' on line 61, col 16
                if _v is not None: write(_filter(_v, rawExpr='$p_type')) # from line 61, col 16.
                write(''' = ...
''')
