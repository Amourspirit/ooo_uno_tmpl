...
__CHEETAH_genTime__ = 1639226852.3861327
__CHEETAH_genTimestamp__ = 'Sat Dec 11 07:47:32 2021'
__CHEETAH_src__ = '_ex.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Dec 11 07:47:21 2021'
...
class ''')
        ...
        write(''')''')
        _v = VFN(VFFSL(SL,"self",True),"get_class_end",False)() # '$self.get_class_end()' on line 39, col 43
        if _v is not None: write(_filter(_v, rawExpr='$self.get_class_end()')) # from line 39, col 43.
        write('''
''')
...
''')
        if VFFSL(SL,"is_properties",True): # generated from line 53, col 1
            ...
            for property in VFFSL(SL,"properties",True): # generated from line 55, col 1
                ...
                p_type = VFFSL(SL,"property",True)['type']
                ...
                write(''': ''')
                _v = VFFSL(SL,"p_type",True) # '$p_type' on line 59, col 16
                if _v is not None: write(_filter(_v, rawExpr='$p_type')) # from line 59, col 16.
                write(''' = ...
''')
