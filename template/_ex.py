...
__CHEETAH_genTime__ = 1644527045.3912888
__CHEETAH_genTimestamp__ = 'Thu Feb 10 16:04:05 2022'
__CHEETAH_src__ = '_ex.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Feb 10 16:03:59 2022'
...
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 110, col 1
            ...
            if attrib_default == 'UNO_NONE': # generated from line 115, col 5
                write('''        if ''')
                _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 116, col 12
                if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 116, col 12.
                write(''' is UNO_NONE:
            self._''')
                _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 117, col 19
                if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 117, col 19.
                write(''' = ''')
                _v = VFN(VFFSL(SL,"self",True),"get_attrib_default",False)(VFFSL(SL,"itm",True)) # '$self.get_attrib_default($itm)' on line 117, col 53
                if _v is not None: write(_filter(_v, rawExpr='$self.get_attrib_default($itm)')) # from line 117, col 53.
                write('''
        else:
            self._''')
                _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 119, col 19
                if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 119, col 19.
                write(''' = ''')
                _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 119, col 53
                if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 119, col 53.
                write('''
''')
            else: # generated from line 120, col 5
                write('''        self._''')
                _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 121, col 15
                if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 121, col 15.
                write(''' = ''')
                _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 121, col 49
                if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 121, col 49.
                write('''
''')
