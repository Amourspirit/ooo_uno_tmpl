...
__CHEETAH_genTime__ = 1642286034.441618
__CHEETAH_genTimestamp__ = 'Sat Jan 15 17:33:54 2022'
__CHEETAH_src__ = '_ex.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Jan 15 17:32:39 2022'
...
''')
        ...
        write(''')''')
        _v = VFN(VFFSL(SL,"self",True),"get_class_end",False)() # '$self.get_class_end()' on line 54, col 55
        if _v is not None: write(_filter(_v, rawExpr='$self.get_class_end()')) # from line 54, col 55.
        write('''
''')
...
''')
            for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"desc",True)): # generated from line 57, col 5
                ...
                write('''
''')
            if VFFSL(SL,"link",True): # generated from line 60, col 5
                write('''
    See Also:
        `API ''')
...
''')
        if VFFSL(SL,"is_properties",True): # generated from line 68, col 1
            properties = VFFSL(SL,"attribs",True)['properties']
            for property in VFFSL(SL,"properties",True): # generated from line 70, col 1
    ...
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 75, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 75, col 9.
                write('''(self) -> ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 75, col 28
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 75, col 28.
                write(''':
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 77, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 78, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 78, col 9.
                    write('''
''')
                if VFN(VFFSL(SL,"self",True),"get_prop_has_errors",False)(VFFSL(SL,"property",True)): # generated from line 80, col 5
                    write('''
        Raises:

''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_get_raises",False)(VFFSL(SL,"property",True)): # generated from line 84, col 5
                        write('''            ''')
                        ...
                        write('''``
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_set_raises",False)(VFFSL(SL,"property",True)): # generated from line 87, col 5
                        write('''            ''')
