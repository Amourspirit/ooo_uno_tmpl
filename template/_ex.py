...
__CHEETAH_genTime__ = 1641672203.739171
__CHEETAH_genTimestamp__ = 'Sat Jan  8 15:03:23 2022'
__CHEETAH_src__ = '_ex.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Jan  8 15:03:12 2022'
...
''')
    ...
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 69, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 69, col 9.
                write('''(self) -> ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 69, col 28
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 69, col 28.
                write(''':
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 71, col 5
                    ...
                    write('''
''')
                if VFN(VFFSL(SL,"self",True),"get_prop_has_errors",False)(VFFSL(SL,"property",True)): # generated from line 74, col 5
                    write('''
        Raises:

''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_get_raises",False)(VFFSL(SL,"property",True)): # generated from line 78, col 5
                        write('''            ''')
                        _v = VFFSL(SL,"long",True) # '$long' on line 79, col 13
                        if _v is not None: write(_filter(_v, rawExpr='$long')) # from line 79, col 13.
                        write(''': get raises ``''')
                        _v = VFFSL(SL,"short",True) # '$short' on line 79, col 33
                        if _v is not None: write(_filter(_v, rawExpr='$short')) # from line 79, col 33.
                        write('''``
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_set_raises",False)(VFFSL(SL,"property",True)): # generated from line 81, col 5
                        write('''            ''')
