...
__CHEETAH_genTime__ = 1643819312.5015798
__CHEETAH_genTimestamp__ = 'Wed Feb  2 11:28:32 2022'
__CHEETAH_src__ = '_ex.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Feb  2 11:28:29 2022'
...
''')
        if VFFSL(SL,"is_properties",True): # generated from line 103, col 1
            ...
            for property in VFFSL(SL,"properties",True): # generated from line 105, col 1
                ...
                write('''    ''')
                _v = VFFSL(SL,"p_name",True) # '$p_name' on line 109, col 5
                if _v is not None: write(_filter(_v, rawExpr='$p_name')) # from line 109, col 5.
                write(''': ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 109, col 14
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 109, col 14.
                write(''' = None
    """
''')
...
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_get_raises",False)(VFFSL(SL,"property",True)): # generated from line 118, col 5
                        write('''        ''')
                        _v = VFFSL(SL,"long",True) # '$long' on line 119, col 9
                        if _v is not None: write(_filter(_v, rawExpr='$long')) # from line 119, col 9.
                        write(''': get raises ``''')
                        _v = VFFSL(SL,"short",True) # '$short' on line 119, col 29
                        if _v is not None: write(_filter(_v, rawExpr='$short')) # from line 119, col 29.
                        write('''``
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_set_raises",False)(VFFSL(SL,"property",True)): # generated from line 121, col 5
                        write('''        ''')
                        _v = VFFSL(SL,"long",True) # '$long' on line 122, col 9
                        if _v is not None: write(_filter(_v, rawExpr='$long')) # from line 122, col 9.
                        write(''': set raises ``''')
                        _v = VFFSL(SL,"short",True) # '$short' on line 122, col 29
                        if _v is not None: write(_filter(_v, rawExpr='$short')) # from line 122, col 29.
                        write('''``
''')
                write('''    """
...
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 137, col 5
                    write('''    ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 138, col 5
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 138, col 5.
                    write('''
''')
