...
__CHEETAH_genTime__ = 1645653773.6965601
__CHEETAH_genTimestamp__ = 'Wed Feb 23 17:02:53 2022'
__CHEETAH_src__ = '_ex.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Feb 23 17:02:45 2022'
...
''')
            for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"desc",True)): # generated from line 76, col 5
                write('''    ''')
...
''')
        ...
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 87, col 24
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 87, col 24.
        write("""'
    __ooo_full_ns__: str = '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 88, col 29
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 88, col 29.
        write("""'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 90, col 32
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 90, col 32.
        write("""'
    __pyunostruct__: str = '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 91, col 29
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 91, col 29.
        write("""'

    typeName: str = '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 93, col 22
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 93, col 22.
        write('''\'
    """Literal Constant ``''')
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 94, col 27
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 94, col 27.
        write('''``"""
    ...
    ''')
        ...
        Keyword Arguments:
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 101, col 1
            index = tpl[1]
            ...
            write('''            ''')
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 107, col 13
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 107, col 13.
            write(''' (''')
            _v = VFFSL(SL,"itm_type",True) # '$itm_type' on line 107, col 24
            if _v is not None: write(_filter(_v, rawExpr='$itm_type')) # from line 107, col 24.
            write(''', optional): ''')
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 107, col 46
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 107, col 46.
            write(''' value.
''')
        write('''
        ...
        """
''')
        if VFN(VFFSL(SL,"self",True),"has_uno_extends",False)(): # generated from line 112, col 1
            write('''        super().__init__(**kwargs)

''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 116, col 1
            index = tpl[1]
            itm = VFFSL(SL,"properties",True)[VFFSL(SL,"index",True)]
            ...
            if attrib_default == 'UNO_NONE': # generated from line 121, col 5
                write('''        if ''')
                _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 122, col 12
                if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 122, col 12.
                write(''' is UNO_NONE:
            self._''')
                ...
                write(''' = ''')
                _v = VFN(VFFSL(SL,"self",True),"get_attrib_default",False)(VFFSL(SL,"itm",True)) # '$self.get_attrib_default($itm)' on line 123, col 53
                if _v is not None: write(_filter(_v, rawExpr='$self.get_attrib_default($itm)')) # from line 123, col 53.
                write('''
        else:
            self._''')
                _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"itm_name",True)) # '$self.camel_to_snake($itm_name)' on line 125, col 19
                if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($itm_name)')) # from line 125, col 19.
                write(''' = ''')
                _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 125, col 53
                if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 125, col 53.
                write('''
''')
                ...
                write(''' = ''')
                _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 127, col 49
                if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 127, col 49.
                write('''
''')
        write('''
''')
        if VFFSL(SL,"is_method",True): # generated from line 131, col 1
            methods = VFFSL(SL,"attribs",True)['methods']
            for method in VFFSL(SL,"methods",True): # generated from line 133, col 5
    ...
    ''')
                _v = VFN(VFFSL(SL,"self",True),"get_formated_meth",False)(VFFSL(SL,"method",True)) # '$self.get_formated_meth($method)' on line 138, col 5
                if _v is not None: write(_filter(_v, rawExpr='$self.get_formated_meth($method)')) # from line 138, col 5.
                write('''
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"m_desc",True)): # generated from line 140, col 9
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 141, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 141, col 9.
                    write('''
''')
                if len(VFFSL(SL,"out_args",True)) > 0: # generated from line 143, col 5
                    write('''
''')
                    for arg in VFFSL(SL,"out_args",True): # generated from line 145, col 9
                        write('''        * ``''')
                        _v = VFFSL(SL,"arg",True) # '${arg}' on line 146, col 13
                        if _v is not None: write(_filter(_v, rawExpr='${arg}')) # from line 146, col 13.
                        write('''`` is an out direction argument.
''')
                if len(VFFSL(SL,"raises",True)) > 0: # generated from line 149, col 5
                    write('''
        Raises:
''')
                    for itm in VFFSL(SL,"raises",True): # generated from line 152, col 9
                        write('''            ''')
                        _v = VFFSL(SL,"itm",True)[0] # '$itm[0]' on line 153, col 13
                        if _v is not None: write(_filter(_v, rawExpr='$itm[0]')) # from line 153, col 13.
                        write(''': ``''')
                        _v = VFFSL(SL,"itm",True)[1] # '$itm[1]' on line 153, col 24
                        if _v is not None: write(_filter(_v, rawExpr='$itm[1]')) # from line 153, col 24.
                        write('''``
''')
                write('''        """
''')
        if VFFSL(SL,"is_properties",True): # generated from line 159, col 1
            for property in VFFSL(SL,"properties",True): # generated from line 160, col 1
    ...
    def ''')
                ...
                write('''(self) -> ''')
                _v = VFFSL(SL,"property",True)['returns'] # "$property['returns']" on line 165, col 28
                if _v is not None: write(_filter(_v, rawExpr="$property['returns']")) # from line 165, col 28.
                write(''':
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 167, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 168, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 168, col 9.
                    write('''
''')
                if VFN(VFFSL(SL,"self",True),"get_prop_has_errors",False)(VFFSL(SL,"property",True)): # generated from line 170, col 5
                    write('''
        Raises:

''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_get_raises",False)(VFFSL(SL,"property",True)): # generated from line 174, col 5
                        write('''            ''')
                        _v = VFFSL(SL,"long",True) # '$long' on line 175, col 13
                        if _v is not None: write(_filter(_v, rawExpr='$long')) # from line 175, col 13.
                        write(''': get raises ``''')
                        _v = VFFSL(SL,"short",True) # '$short' on line 175, col 33
                        if _v is not None: write(_filter(_v, rawExpr='$short')) # from line 175, col 33.
                        write('''``
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_set_raises",False)(VFFSL(SL,"property",True)): # generated from line 177, col 5
                        write('''            ''')
                        _v = VFFSL(SL,"long",True) # '$long' on line 178, col 13
                        if _v is not None: write(_filter(_v, rawExpr='$long')) # from line 178, col 13.
                        write(''': set raises ``''')
                        _v = VFFSL(SL,"short",True) # '$short' on line 178, col 33
                        if _v is not None: write(_filter(_v, rawExpr='$short')) # from line 178, col 33.
                        write('''``
''')
                write('''        """
        return self._''')
                _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"p_name",True)) # '$self.camel_to_snake($p_name)' on line 182, col 22
                if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($p_name)')) # from line 182, col 22.
                write('''
    
    @''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 184, col 6
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 184, col 6.
                write('''.setter
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 185, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 185, col 9.
                write('''(self, value: ''')
                _v = VFFSL(SL,"property",True)['returns'] # "$property['returns']" on line 185, col 32
                if _v is not None: write(_filter(_v, rawExpr="$property['returns']")) # from line 185, col 32.
                write(''') -> None:
        self._''')
                _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"p_name",True)) # '$self.camel_to_snake($p_name)' on line 186, col 15
                if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($p_name)')) # from line 186, col 15.
                write(''' = value
