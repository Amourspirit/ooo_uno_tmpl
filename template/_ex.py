...
__CHEETAH_genTime__ = 1656786835.1151621
__CHEETAH_genTimestamp__ = 'Sat Jul  2 14:33:55 2022'
__CHEETAH_src__ = '_ex.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Jul  2 14:31:58 2022'
...
''')
        ...
        ...
''')
        if VFFSL(SL,"is_properties",True): # generated from line 183, col 1
            for property in VFFSL(SL,"properties",True): # generated from line 184, col 1
                ...
                write('''    @property
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 189, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 189, col 9.
                write('''(self) -> ''')
                _v = VFFSL(SL,"property",True)['returns'] # "$property['returns']" on line 189, col 28
                if _v is not None: write(_filter(_v, rawExpr="$property['returns']")) # from line 189, col 28.
                write(''':
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 191, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 192, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 192, col 9.
                    write('''
''')
                if VFN(VFFSL(SL,"self",True),"get_prop_has_errors",False)(VFFSL(SL,"property",True)): # generated from line 194, col 5
                    write('''
        Raises:

''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_get_raises",False)(VFFSL(SL,"property",True)): # generated from line 198, col 5
                        write('''            ''')
                        ...
                        write('''``
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_set_raises",False)(VFFSL(SL,"property",True)): # generated from line 201, col 5
                        write('''            ''')
                        _v = VFFSL(SL,"long",True) # '$long' on line 202, col 13
                        if _v is not None: write(_filter(_v, rawExpr='$long')) # from line 202, col 13.
                        write(''': set raises ``''')
                        _v = VFFSL(SL,"short",True) # '$short' on line 202, col 33
                        if _v is not None: write(_filter(_v, rawExpr='$short')) # from line 202, col 33.
                        write('''``
''')
                write('''        """
        return self._''')
                _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"p_name",True)) # '$self.camel_to_snake($p_name)' on line 206, col 22
                if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($p_name)')) # from line 206, col 22.
                write('''
    
    @''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 208, col 6
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 208, col 6.
                write('''.setter
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 209, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 209, col 9.
                write('''(self, value: ''')
                _v = VFFSL(SL,"property",True)['returns'] # "$property['returns']" on line 209, col 32
                if _v is not None: write(_filter(_v, rawExpr="$property['returns']")) # from line 209, col 32.
                write(''') -> None:
        self._''')
                _v = VFN(VFFSL(SL,"self",True),"camel_to_snake",False)(VFFSL(SL,"p_name",True)) # '$self.camel_to_snake($p_name)' on line 210, col 15
                if _v is not None: write(_filter(_v, rawExpr='$self.camel_to_snake($p_name)')) # from line 210, col 15.
                write(''' = value

''')
        write("""
__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 215, col 13
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 215, col 13.
        write("""']
""")
