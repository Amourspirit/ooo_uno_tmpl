...
__CHEETAH_genTime__ = 1684280134.7719307
__CHEETAH_genTimestamp__ = 'Tue May 16 19:35:34 2023'
__CHEETAH_src__ = '_x_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Tue May 16 19:35:31 2023'
...
''')
        for imp in VFFSL(SL,"imports",True): # generated from line 50, col 1
            write('''import ''')
            _v = VFFSL(SL,"imp",True) # '$imp' on line 51, col 8
            if _v is not None: write(_filter(_v, rawExpr='$imp')) # from line 51, col 8.
            write('''
''')
        if len(VFFSL(SL,"abc_imports",True)) > 0: # generated from line 53, col 1
            write('''from abc import ''')
            _v = VFN(VFFSL(SL,"self",True),"lst_to_str",False)(VFFSL(SL,"abc_imports",True)) # '$self.lst_to_str($abc_imports)' on line 54, col 17
            if _v is not None: write(_filter(_v, rawExpr='$self.lst_to_str($abc_imports)')) # from line 54, col 17.
            write('''
''')
        for imp in VFFSL(SL,"from_imports",True): # generated from line 56, col 1
            _v = VFN(VFFSL(SL,"self",True),"get_from_import",False)(VFFSL(SL,"name",True), VFFSL(SL,"imp",True)) # '$self.get_from_import($name, $imp)' on line 57, col 1
            if _v is not None: write(_filter(_v, rawExpr='$self.get_from_import($name, $imp)')) # from line 57, col 1.
            write('''
''')
        if len(VFFSL(SL,"from_imports_typing",True)) > 0: # generated from line 59, col 1
            write('''if typing.TYPE_CHECKING:
''')
            for imp in VFFSL(SL,"from_imports_typing",True): # generated from line 61, col 1
                write('''    ''')
                _v = VFN(VFFSL(SL,"self",True),"get_from_import",False)(VFFSL(SL,"name",True), VFFSL(SL,"imp",True)) # '$self.get_from_import($name, $imp)' on line 62, col 5
                if _v is not None: write(_filter(_v, rawExpr='$self.get_from_import($name, $imp)')) # from line 62, col 5.
                write('''
''')
        write('''
...
''')
        if VFFSL(SL,"allow_db",True): # generated from line 67, col 1
            ...
            write('''(''')
            _v = VFN(VFFSL(SL,"self",True),"get_class_inherits_from_db",False)('ABC') # "$self.get_class_inherits_from_db('ABC')" on line 68, col 20
            if _v is not None: write(_filter(_v, rawExpr="$self.get_class_inherits_from_db('ABC')")) # from line 68, col 20.
            write('''):
''')
            ...
            write('''(''')
            _v = VFN(VFFSL(SL,"self",True),"get_class_inherits",False)(VFFSL(SL,"name",True), VFFSL(SL,"inherits",True)) # '$self.get_class_inherits($name, $inherits)' on line 70, col 20
            if _v is not None: write(_filter(_v, rawExpr='$self.get_class_inherits($name, $inherits)')) # from line 70, col 20.
            write('''):
''')
        write('''    """
''')
        for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"desc",True)): # generated from line 73, col 5
            write('''    ''')
            _v = VFFSL(SL,"line",True) # '$line' on line 74, col 5
            if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 74, col 5.
            write('''
''')
        if VFFSL(SL,"link",True): # generated from line 76, col 1
            write('''
    See Also:
        `API ''')
            _v = VFFSL(SL,"name",True) # '$name' on line 79, col 14
            if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 79, col 14.
            write(''' <''')
            _v = VFFSL(SL,"link",True) # '$link' on line 79, col 21
            if _v is not None: write(_filter(_v, rawExpr='$link')) # from line 79, col 21.
            write('''>`_
''')
        write('''    """
    __pyunointerface__: Literal[\'''')
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 82, col 34
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 82, col 34.
        write("""']
