...
__CHEETAH_genTime__ = 1684083488.4053676
__CHEETAH_genTimestamp__ = 'Sun May 14 12:58:08 2023'
__CHEETAH_src__ = '_x_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Sun May 14 12:56:16 2023'
...
''')
        ...
        ...
    @''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 135, col 6
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 135, col 6.
                write('''.setter
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 136, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 136, col 9.
                write('''(self, value: ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 136, col 32
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 136, col 32.
                write(''') -> None:
        ...
''')
        if VFFSL(SL,"is_properties",True): # generated from line 140, col 1
            properties = VFFSL(SL,"attribs",True)['properties']
            for property in VFFSL(SL,"properties",True): # generated from line 142, col 1
                p_name = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"property",True)['name'])
                p_return = VFN(VFFSL(SL,"self",True),"get_q_type",False)(VFFSL(SL,"property",True)['returns'])
                p_desc = VFFSL(SL,"property",True)['desc']
                write('''    @property
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 147, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 147, col 9.
                write('''(self) -> ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 147, col 28
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 147, col 28.
                write(''':
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 149, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 150, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 150, col 9.
                    write('''
''')
                if VFN(VFFSL(SL,"self",True),"get_prop_has_errors",False)(VFFSL(SL,"property",True)): # generated from line 152, col 5
                    write('''
        Raises:

''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_get_raises",False)(VFFSL(SL,"property",True)): # generated from line 156, col 5
                        write('''            ''')
                        ...
                        write('''``
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_set_raises",False)(VFFSL(SL,"property",True)): # generated from line 159, col 5
                        write('''            ''')
...
''')
        ...
        ...
    @''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 165, col 6
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 165, col 6.
                write('''.setter
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 166, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 166, col 9.
                write('''(self, value: ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 166, col 32
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 166, col 32.
                write(''') -> None:
        ...
''')
