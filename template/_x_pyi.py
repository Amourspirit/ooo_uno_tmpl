...
__CHEETAH_genTime__ = 1684705937.2474391
__CHEETAH_genTimestamp__ = 'Sun May 21 17:52:17 2023'
__CHEETAH_src__ = '_x_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Sun May 21 17:52:06 2023'
...
""")
        if VFFSL(SL,"is_method",True): # generated from line 82, col 1
            ...
            for method in VFFSL(SL,"methods",True): # generated from line 84, col 5
                ...
                write('''    ''')
                _v = VFN(VFFSL(SL,"self",True),"get_formated_meth",False)(VFFSL(SL,"method",True)) # '$self.get_formated_meth($method)' on line 88, col 5
                if _v is not None: write(_filter(_v, rawExpr='$self.get_formated_meth($method)')) # from line 88, col 5.
                write('''
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"m_desc",True)): # generated from line 90, col 9
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 91, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 91, col 9.
                    write('''
''')
                if len(VFFSL(SL,"out_args",True)) > 0: # generated from line 93, col 5
                    write('''
''')
                    for arg in VFFSL(SL,"out_args",True): # generated from line 95, col 9
                        write('''        * ``''')
                        _v = VFFSL(SL,"arg",True) # '${arg}' on line 96, col 13
                        if _v is not None: write(_filter(_v, rawExpr='${arg}')) # from line 96, col 13.
                        write('''`` is an out direction argument.
''')
                if len(VFFSL(SL,"raises",True)) > 0: # generated from line 99, col 5
                    write('''
        Raises:
''')
                    for itm in VFFSL(SL,"raises",True): # generated from line 102, col 9
                        write('''            ''')
                        _v = VFFSL(SL,"itm",True)[0] # '$itm[0]' on line 103, col 13
                        if _v is not None: write(_filter(_v, rawExpr='$itm[0]')) # from line 103, col 13.
                        write(''': ``''')
                        _v = VFFSL(SL,"itm",True)[1] # '$itm[1]' on line 103, col 24
                        if _v is not None: write(_filter(_v, rawExpr='$itm[1]')) # from line 103, col 24.
                        write('''``
''')
                write('''        """
        ...
