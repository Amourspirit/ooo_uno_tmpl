...
__CHEETAH_genTime__ = 1650237308.6630344
__CHEETAH_genTimestamp__ = 'Sun Apr 17 19:15:08 2022'
__CHEETAH_src__ = '_const_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Sun Apr 17 19:15:00 2022'
...
''')
        if isinstance(VFFSL(SL,"desc",True), str): # generated from line 48, col 5
            _v = VFFSL(SL,"desc",True) # '$desc' on line 49, col 1
            if _v is not None: write(_filter(_v, rawExpr='$desc')) # from line 49, col 1.
            write('''
''')
        else: # generated from line 50, col 5
            for line in VFFSL(SL,"desc",True): # generated from line 51, col 9
                _v = VFFSL(SL,"line",True) # '$line' on line 52, col 1
                if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 52, col 1.
                write('''
''')
...
See Also:
    `API ''')
            _v = VFFSL(SL,"name",True) # '$name' on line 58, col 10
            if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 58, col 10.
            write(''' <''')
            _v = VFFSL(SL,"link",True) # '$link' on line 58, col 17
            if _v is not None: write(_filter(_v, rawExpr='$link')) # from line 58, col 17.
            write('''>`_
''')
        write('''"""
''')
        for item in VFFSL(SL,"attribs",True): # generated from line 61, col 1
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"item",True)['name']) # "$self.get_safe_word($item['name'])" on line 62, col 1
            if _v is not None: write(_filter(_v, rawExpr="$self.get_safe_word($item['name'])")) # from line 62, col 1.
            write(''': ''')
            _v = VFN(VFFSL(SL,"self",True),"get_const_type",False)(VFFSL(SL,"item",True)) # '$self.get_const_type($item)' on line 62, col 37
            if _v is not None: write(_filter(_v, rawExpr='$self.get_const_type($item)')) # from line 62, col 37.
            write('''
''')
            if len(VFFSL(SL,"item",True)['lines']) > 0: # generated from line 63, col 5
                write('''"""
''')
                if isinstance(VFFSL(SL,"item",True)['lines'], str): # generated from line 65, col 9
                    _v = VFFSL(SL,"item",True)['lines'] # "$item['lines']" on line 66, col 1
                    if _v is not None: write(_filter(_v, rawExpr="$item['lines']")) # from line 66, col 1.
                    write('''
''')
                else: # generated from line 67, col 9
                    for line in VFFSL(SL,"item",True)['lines']: # generated from line 68, col 13
                        _v = VFFSL(SL,"line",True) # '$line' on line 69, col 1
                        if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 69, col 1.
                        write('''
''')
                write('''"""
''')
