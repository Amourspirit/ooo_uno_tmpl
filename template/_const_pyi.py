...
__CHEETAH_genTime__ = 1649867726.1805077
__CHEETAH_genTimestamp__ = 'Wed Apr 13 12:35:26 2022'
__CHEETAH_src__ = '_const_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Apr 13 12:35:21 2022'
...
''')
        for item in VFFSL(SL,"attribs",True): # generated from line 64, col 1
            ...
            write(''': ''')
            _v = VFN(VFFSL(SL,"self",True),"get_const_type",False)(VFFSL(SL,"item",True)) # '$self.get_const_type($item)' on line 65, col 41
            if _v is not None: write(_filter(_v, rawExpr='$self.get_const_type($item)')) # from line 65, col 41.
            write('''
''')
