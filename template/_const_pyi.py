...
__CHEETAH_genTime__ = 1671747771.0956097
__CHEETAH_genTimestamp__ = 'Thu Dec 22 17:22:51 2022'
__CHEETAH_src__ = '_const_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Dec 22 17:22:38 2022'
...
''')
        for frm, imp in VFFSL(SL,"from_imports",True): # generated from line 44, col 1
            ...
            write('''
''')
        for frm, imp in VFFSL(SL,"from_typing_imports",True): # generated from line 47, col 1
            write('''from ''')
            _v = VFFSL(SL,"frm",True) # '$frm' on line 48, col 6
            if _v is not None: write(_filter(_v, rawExpr='$frm')) # from line 48, col 6.
            write(''' import ''')
            _v = VFFSL(SL,"imp",True) # '$imp' on line 48, col 18
            if _v is not None: write(_filter(_v, rawExpr='$imp')) # from line 48, col 18.
            write('''
''')
        if VFFSL(SL,"write_class",True): # generated from line 50, col 1
            write('''
...
''')
        if isinstance(VFFSL(SL,"desc",True), str): # generated from line 58, col 5
            _v = VFFSL(SL,"indt",True) # '${indt}' on line 59, col 1
            if _v is not None: write(_filter(_v, rawExpr='${indt}')) # from line 59, col 1.
            _v = VFFSL(SL,"desc",True) # '${desc}' on line 59, col 8
            if _v is not None: write(_filter(_v, rawExpr='${desc}')) # from line 59, col 8.
            write('''
''')
...
''')
        ...
        write('''"""
''')
        for item in VFFSL(SL,"attribs",True): # generated from line 71, col 1
            _v = VFFSL(SL,"indt",True) # '${indt}' on line 72, col 1
            if _v is not None: write(_filter(_v, rawExpr='${indt}')) # from line 72, col 1.
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"item",True)['name']) # "$self.get_safe_word($item['name'])" on line 72, col 8
            if _v is not None: write(_filter(_v, rawExpr="$self.get_safe_word($item['name'])")) # from line 72, col 8.
            write(''': ''')
            _v = VFN(VFFSL(SL,"self",True),"get_const_type",False)(VFFSL(SL,"item",True)) # '$self.get_const_type($item)' on line 72, col 44
            if _v is not None: write(_filter(_v, rawExpr='$self.get_const_type($item)')) # from line 72, col 44.
            write('''
''')
            if len(VFFSL(SL,"item",True)['lines']) > 0: # generated from line 73, col 5
                _v = VFFSL(SL,"indt",True) # '${indt}' on line 74, col 1
                if _v is not None: write(_filter(_v, rawExpr='${indt}')) # from line 74, col 1.
                write('''"""
''')
                if isinstance(VFFSL(SL,"item",True)['lines'], str): # generated from line 75, col 9
                    _v = VFFSL(SL,"indt",True) # '${indt}' on line 76, col 1
                    if _v is not None: write(_filter(_v, rawExpr='${indt}')) # from line 76, col 1.
                    _v = VFFSL(SL,"item",True)['lines'] # "$item['lines']" on line 76, col 8
                    if _v is not None: write(_filter(_v, rawExpr="$item['lines']")) # from line 76, col 8.
                    write('''
''')
                else: # generated from line 77, col 9
                    for line in VFFSL(SL,"item",True)['lines']: # generated from line 78, col 13
