...
__CHEETAH_genTime__ = 1649860433.6583626
__CHEETAH_genTimestamp__ = 'Wed Apr 13 10:33:53 2022'
__CHEETAH_src__ = '_const_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Apr 13 10:33:18 2022'
...
''')
        for item in VFFSL(SL,"attribs",True): # generated from line 64, col 1
            if isinstance(VFFSL(SL,"item",True)['value'], (int, float, str)): # generated from line 65, col 5
                write('''    ''')
                _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"item",True)['name']) # "$self.get_safe_word($item['name'])" on line 66, col 5
                if _v is not None: write(_filter(_v, rawExpr="$self.get_safe_word($item['name'])")) # from line 66, col 5.
                write(''': Literal[''')
                _v = VFFSL(SL,"item",True)['value'] # "$item['value']" on line 66, col 49
                if _v is not None: write(_filter(_v, rawExpr="$item['value']")) # from line 66, col 49.
                write(''']
''')
                ...
                write(''': ''')
                _v = VFN(VFFSL(SL,"self",True),"get_q_type",False)(VFFSL(SL,"item",True)['value']) # "$self.get_q_type($item['value'])" on line 68, col 41
                if _v is not None: write(_filter(_v, rawExpr="$self.get_q_type($item['value'])")) # from line 68, col 41.
                write('''
''')
            if len(VFFSL(SL,"item",True)['lines']) > 0: # generated from line 70, col 5
                write('''    """
''')
                if isinstance(VFFSL(SL,"item",True)['lines'], str): # generated from line 72, col 9
                    write('''    ''')
                    _v = VFFSL(SL,"item",True)['lines'] # "$item['lines']" on line 73, col 5
                    if _v is not None: write(_filter(_v, rawExpr="$item['lines']")) # from line 73, col 5.
                    write('''
''')
                else: # generated from line 74, col 9
                    for line in VFFSL(SL,"item",True)['lines']: # generated from line 75, col 13
                        write('''    ''')
