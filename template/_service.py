...
__CHEETAH_genTime__ = 1643847532.1529083
__CHEETAH_genTimestamp__ = 'Wed Feb  2 19:18:52 2022'
__CHEETAH_src__ = '_service.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Feb  2 19:18:48 2022'
...
''')
        if VFFSL(SL,"is_method",True): # generated from line 78, col 1
            methods = VFFSL(SL,"attribs",True)['methods']
            for method in VFFSL(SL,"methods",True): # generated from line 80, col 5
    ...
    ''')
                _v = VFN(VFFSL(SL,"self",True),"get_formated_meth",False)(VFFSL(SL,"method",True)) # '$self.get_formated_meth($method)' on line 85, col 5
                if _v is not None: write(_filter(_v, rawExpr='$self.get_formated_meth($method)')) # from line 85, col 5.
                write('''
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"m_desc",True)): # generated from line 87, col 9
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 88, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 88, col 9.
                    write('''
''')
                if len(VFFSL(SL,"out_args",True)) > 0: # generated from line 90, col 5
                    write('''
''')
                    for arg in VFFSL(SL,"out_args",True): # generated from line 92, col 9
                        write('''        * ``''')
                        _v = VFFSL(SL,"arg",True) # '${arg}' on line 93, col 13
                        if _v is not None: write(_filter(_v, rawExpr='${arg}')) # from line 93, col 13.
                        write('''`` is an out direction argument.
''')
                if len(VFFSL(SL,"raises",True)) > 0: # generated from line 96, col 5
                    write('''
        Raises:
''')
                    for itm in VFFSL(SL,"raises",True): # generated from line 99, col 9
                        write('''            ''')
                        _v = VFFSL(SL,"itm",True)[0] # '$itm[0]' on line 100, col 13
                        if _v is not None: write(_filter(_v, rawExpr='$itm[0]')) # from line 100, col 13.
                        write(''': ``''')
                        _v = VFFSL(SL,"itm",True)[1] # '$itm[1]' on line 100, col 24
                        if _v is not None: write(_filter(_v, rawExpr='$itm[1]')) # from line 100, col 24.
                        write('''``
''')
                write('''        """
''')
        if VFFSL(SL,"is_properties",True): # generated from line 106, col 1
            properties = VFFSL(SL,"attribs",True)['properties']
            for property in VFFSL(SL,"properties",True): # generated from line 108, col 1
    ...
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 113, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 113, col 9.
                write('''(self) -> ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 113, col 28
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 113, col 28.
                write(''':
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 115, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 116, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 116, col 9.
                    write('''
''')
                if VFN(VFFSL(SL,"self",True),"get_prop_has_errors",False)(VFFSL(SL,"property",True)): # generated from line 118, col 5
                    write('''
        Raises:

''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_get_raises",False)(VFFSL(SL,"property",True)): # generated from line 122, col 5
                        write('''            ''')
                        ...
                        write('''``
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_set_raises",False)(VFFSL(SL,"property",True)): # generated from line 125, col 5
                        write('''            ''')
...
''')
                write('''        """
''')
        if VFFSL(SL,"is_types",True): # generated from line 132, col 1
    ...
    def ''')
                ...
                write('''(self) -> ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 139, col 28
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 139, col 28.
                write(''':
        """
''')
...
''')
        write("""
__all__ = ['""")
        _v = VFFSL(SL,"name",True) # '$name' on line 159, col 13
        if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 159, col 13.
        write("""']
""")
