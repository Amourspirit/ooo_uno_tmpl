...
__CHEETAH_genTime__ = 1641349096.6387668
__CHEETAH_genTimestamp__ = 'Tue Jan  4 21:18:16 2022'
__CHEETAH_src__ = '_service.tmpl'
__CHEETAH_srcLastModified__ = 'Tue Jan  4 21:17:28 2022'
...
''')
            for frm, imp in VFFSL(SL,"from_imports_typing",True): # generated from line 52, col 1
                write('''    from ''')
                _v = VFFSL(SL,"frm",True) # '$frm' on line 53, col 10
                if _v is not None: write(_filter(_v, rawExpr='$frm')) # from line 53, col 10.
                write(''' import ''')
                _v = VFFSL(SL,"imp",True) # '$imp' on line 53, col 22
                if _v is not None: write(_filter(_v, rawExpr='$imp')) # from line 53, col 22.
                write('''
''')
        write('''
