...
__CHEETAH_genTime__ = 1641067869.799775
__CHEETAH_genTimestamp__ = 'Sat Jan  1 15:11:09 2022'
__CHEETAH_src__ = '_service.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Jan  1 15:10:17 2022'
...
class ''')
        ...
        write('''(''')
        _v = VFN(VFFSL(SL,"self",True),"lst_to_str",False)(VFFSL(SL,"inherits",True)) # '$self.lst_to_str($inherits)' on line 28, col 20
        if _v is not None: write(_filter(_v, rawExpr='$self.lst_to_str($inherits)')) # from line 28, col 20.
        write(''')''')
        _v = VFN(VFFSL(SL,"self",True),"get_class_end",False)() # '$self.get_class_end()' on line 28, col 48
        if _v is not None: write(_filter(_v, rawExpr='$self.get_class_end()')) # from line 28, col 48.
        write('''
''')
