...
__CHEETAH_genTime__ = 1725109518.4809022
__CHEETAH_genTimestamp__ = 'Sat Aug 31 09:05:18 2024'
__CHEETAH_src__ = '_service.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Aug 31 09:02:52 2024'
...
''')
    ...
    @abstractmethod
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 121, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 121, col 9.
                write('''(self) -> ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 121, col 28
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 121, col 28.
                write(''':
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 123, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 124, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 124, col 9.
                    write('''
''')
                if VFN(VFFSL(SL,"self",True),"get_prop_has_errors",False)(VFFSL(SL,"property",True)): # generated from line 126, col 5
                    write('''
        Raises:

''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_get_raises",False)(VFFSL(SL,"property",True)): # generated from line 130, col 5
                        write('''            ''')
                        ...
                        write('''``
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_set_raises",False)(VFFSL(SL,"property",True)): # generated from line 133, col 5
                        write('''            ''')
                        _v = VFFSL(SL,"long",True) # '$long' on line 134, col 13
                        if _v is not None: write(_filter(_v, rawExpr='$long')) # from line 134, col 13.
                        write(''': set raises ``''')
                        _v = VFFSL(SL,"short",True) # '$short' on line 134, col 33
                        if _v is not None: write(_filter(_v, rawExpr='$short')) # from line 134, col 33.
                        write('''``
''')
                write('''        """
        ...
...
''')
        if VFFSL(SL,"is_properties",True): # generated from line 142, col 1
            properties = VFFSL(SL,"attribs",True)['properties']
            for property in VFFSL(SL,"properties",True): # generated from line 144, col 1
                p_name = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"property",True)['name'])
                p_return = VFN(VFFSL(SL,"self",True),"get_property_return",False)(VFFSL(SL,"property",True))
                p_desc = VFFSL(SL,"property",True)['desc']
                write('''    @property
...
''')
        write("""
__all__ = ['""")
        _v = VFFSL(SL,"name",True) # '$name' on line 172, col 13
        if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 172, col 13.
        write("""']
""")
