...
__CHEETAH_genTime__ = 1641576048.7657287
__CHEETAH_genTimestamp__ = 'Fri Jan  7 12:20:48 2022'
__CHEETAH_src__ = '_service.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Jan  7 12:12:12 2022'
...
''')
            for frm, imp in VFFSL(SL,"from_imports_typing",True): # generated from line 53, col 1
                write('''    from ''')
                _v = VFFSL(SL,"frm",True) # '$frm' on line 54, col 10
                if _v is not None: write(_filter(_v, rawExpr='$frm')) # from line 54, col 10.
                write(''' import ''')
                _v = VFFSL(SL,"imp",True) # '$imp' on line 54, col 22
                if _v is not None: write(_filter(_v, rawExpr='$imp')) # from line 54, col 22.
                write('''
''')
        write('''
