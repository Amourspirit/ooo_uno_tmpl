...
__CHEETAH_genTime__ = 1642107369.5102408
__CHEETAH_genTimestamp__ = 'Thu Jan 13 15:56:09 2022'
__CHEETAH_src__ = '_service.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Jan 13 15:55:15 2022'
...
''')
        ...
        write('''(''')
        _v = VFN(VFFSL(SL,"self",True),"get_class_inherits_from_db",False)('ABC') # "$self.get_class_inherits_from_db('ABC')" on line 59, col 20
        if _v is not None: write(_filter(_v, rawExpr="$self.get_class_inherits_from_db('ABC')")) # from line 59, col 20.
        write('''):
    """
''')
