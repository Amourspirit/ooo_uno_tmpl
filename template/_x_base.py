...
__CHEETAH_genTime__ = 1644427633.4179683
__CHEETAH_genTimestamp__ = 'Wed Feb  9 12:27:13 2022'
__CHEETAH_src__ = '_x_base.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Feb  9 12:25:06 2022'
...
""")
        if VFFSL(SL,"is_types",True): # generated from line 82, col 1
            properties = VFFSL(SL,"attribs",True)['types']
            for property in VFFSL(SL,"properties",True): # generated from line 84, col 1
                ...
                write('''    ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 88, col 5
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 88, col 5.
                write(''' = ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 88, col 17
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 88, col 17.
                write('''
    """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 90, col 5
                    write('''    ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 91, col 5
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 91, col 5.
                    write('''
''')
                write('''    """

''')
        if VFFSL(SL,"is_method",True): # generated from line 97, col 1
            methods = VFFSL(SL,"attribs",True)['methods']
            for method in VFFSL(SL,"methods",True): # generated from line 99, col 5
    ...
    ''')
                _v = VFN(VFFSL(SL,"self",True),"get_formated_meth",False)(VFFSL(SL,"method",True)) # '$self.get_formated_meth($method)' on line 104, col 5
                if _v is not None: write(_filter(_v, rawExpr='$self.get_formated_meth($method)')) # from line 104, col 5.
                write('''
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"m_desc",True)): # generated from line 106, col 9
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 107, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 107, col 9.
                    write('''
''')
                if len(VFFSL(SL,"out_args",True)) > 0: # generated from line 109, col 5
                    write('''
''')
                    for arg in VFFSL(SL,"out_args",True): # generated from line 111, col 9
                        write('''        * ``''')
                        _v = VFFSL(SL,"arg",True) # '${arg}' on line 112, col 13
                        if _v is not None: write(_filter(_v, rawExpr='${arg}')) # from line 112, col 13.
                        write('''`` is an out direction argument.
''')
                if len(VFFSL(SL,"raises",True)) > 0: # generated from line 115, col 5
                    write('''
        Raises:
''')
                    for itm in VFFSL(SL,"raises",True): # generated from line 118, col 9
                        write('''            ''')
                        _v = VFFSL(SL,"itm",True)[0] # '$itm[0]' on line 119, col 13
                        if _v is not None: write(_filter(_v, rawExpr='$itm[0]')) # from line 119, col 13.
                        write(''': ``''')
                        _v = VFFSL(SL,"itm",True)[1] # '$itm[1]' on line 119, col 24
                        if _v is not None: write(_filter(_v, rawExpr='$itm[1]')) # from line 119, col 24.
                        write('''``
''')
                write('''        """
''')
        if VFFSL(SL,"is_properties",True): # generated from line 125, col 1
