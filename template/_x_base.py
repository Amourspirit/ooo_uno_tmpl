...
__CHEETAH_genTime__ = 1650144881.6854124
__CHEETAH_genTimestamp__ = 'Sat Apr 16 17:34:41 2022'
__CHEETAH_src__ = '_x_base.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Apr 15 20:54:18 2022'
...
''')
        write('''    """
    __ooo_ns__: str = \'''')
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 77, col 24
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 77, col 24.
        write("""'
    __ooo_full_ns__: str = '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 78, col 29
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 78, col 29.
        write("""'
    __ooo_type_name__: str = 'interface'
    __pyunointerface__: str = '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 80, col 32
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 80, col 32.
        write("""'

""")
        if VFFSL(SL,"is_method",True): # generated from line 82, col 1
            methods = VFFSL(SL,"attribs",True)['methods']
            for method in VFFSL(SL,"methods",True): # generated from line 84, col 5
...
''')
                write('''        """
''')
        if VFFSL(SL,"is_types",True): # generated from line 110, col 1
            properties = VFFSL(SL,"attribs",True)['types']
            for property in VFFSL(SL,"properties",True): # generated from line 112, col 1
    ...
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 117, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 117, col 9.
                write('''(self) -> ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 117, col 28
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 117, col 28.
                write(''':
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 119, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 120, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 120, col 9.
                    write('''
''')
                if VFN(VFFSL(SL,"self",True),"get_prop_has_errors",False)(VFFSL(SL,"property",True)): # generated from line 122, col 5
                    write('''
        Raises:

''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_get_raises",False)(VFFSL(SL,"property",True)): # generated from line 126, col 5
                        write('''            ''')
                        ...
                        write('''``
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_set_raises",False)(VFFSL(SL,"property",True)): # generated from line 129, col 5
                        write('''            ''')
...
''')
    ...
    def ''')
                ...
                write('''(self) -> ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 144, col 28
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 144, col 28.
                write(''':
        """
''')
...
''')
        write("""
__all__ = ['""")
        _v = VFFSL(SL,"name",True) # '$name' on line 165, col 13
        if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 165, col 13.
        write("""']
""")
