...
__CHEETAH_genTime__ = 1644173114.797069
__CHEETAH_genTimestamp__ = 'Sun Feb  6 13:45:14 2022'
__CHEETAH_src__ = '_x_base.tmpl'
__CHEETAH_srcLastModified__ = 'Sun Feb  6 13:42:46 2022'
...
''')
                write('''        """
''')
        if VFFSL(SL,"is_properties",True): # generated from line 110, col 1
...
''')
                write('''        """
''')
        if VFFSL(SL,"is_types",True): # generated from line 136, col 1
    ...
    def ''')
                ...
                write('''(self) -> ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 143, col 28
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 143, col 28.
                write(''':
        """
''')
...
''')
        write("""
__all__ = ['""")
        _v = VFFSL(SL,"name",True) # '$name' on line 163, col 13
        if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 163, col 13.
        write("""']
""")
