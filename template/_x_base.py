...
__CHEETAH_genTime__ = 1656774118.9321258
__CHEETAH_genTimestamp__ = 'Sat Jul  2 11:01:58 2022'
__CHEETAH_src__ = '_x_base.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Jul  2 10:59:10 2022'
...
''')
        write("""
__all__ = ['""")
        _v = VFFSL(SL,"name",True) # '$name' on line 168, col 13
        if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 168, col 13.
        write("""']
""")
