...
__CHEETAH_genTime__ = 1649885575.7724743
__CHEETAH_genTimestamp__ = 'Wed Apr 13 17:32:55 2022'
__CHEETAH_src__ = '_ex_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Apr 13 17:32:50 2022'
...
# Namespace: ''')
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 46, col 14
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 46, col 14.
        write('''
''')
        if VFFSL(SL,"libre_office_ver",True): # generated from line 47, col 1
            write('''# Libre Office Version: ''')
            _v = VFFSL(SL,"libre_office_ver",True) # '$libre_office_ver' on line 48, col 25
            if _v is not None: write(_filter(_v, rawExpr='$libre_office_ver')) # from line 48, col 25.
            write('''
...
''')
        ...
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 93, col 24
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 93, col 24.
        write("""']

    """)
        _v = VFN(VFFSL(SL,"self",True),"get_constructor",False)() # '$self.get_constructor()' on line 95, col 5
        if _v is not None: write(_filter(_v, rawExpr='$self.get_constructor()')) # from line 95, col 5.
        write('''
        """
        Constructor
        ...
        Arguments:
''')
        for arg in VFFSL(SL,"args_all",True): # generated from line 100, col 1
            arg_type = re.sub(re_underscore_hex, '', VFFSL(SL,"arg.type",True), 1)
            write('''            ''')
            _v = VFFSL(SL,"arg.name",True) # '$arg.name' on line 102, col 13
            if _v is not None: write(_filter(_v, rawExpr='$arg.name')) # from line 102, col 13.
            write(''' (''')
            _v = VFFSL(SL,"arg_type",True) # '$arg_type' on line 102, col 24
            if _v is not None: write(_filter(_v, rawExpr='$arg_type')) # from line 102, col 24.
            write(''', optional): ''')
            _v = VFFSL(SL,"arg.name",True) # '$arg.name' on line 102, col 46
            if _v is not None: write(_filter(_v, rawExpr='$arg.name')) # from line 102, col 46.
            write(''' value.
''')
        write('''        """
''')
        if VFFSL(SL,"is_method",True): # generated from line 105, col 1
            methods = VFFSL(SL,"attribs",True)['methods']
            for method in VFFSL(SL,"methods",True): # generated from line 107, col 5
                ...
                write('''    ''')
                _v = VFN(VFFSL(SL,"self",True),"get_formated_meth",False)(VFFSL(SL,"method",True)) # '$self.get_formated_meth($method)' on line 111, col 5
                if _v is not None: write(_filter(_v, rawExpr='$self.get_formated_meth($method)')) # from line 111, col 5.
                write('''
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"m_desc",True)): # generated from line 113, col 9
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 114, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 114, col 9.
                    write('''
''')
                if len(VFFSL(SL,"out_args",True)) > 0: # generated from line 116, col 5
                    write('''
''')
                    for arg in VFFSL(SL,"out_args",True): # generated from line 118, col 9
                        write('''        * ``''')
                        _v = VFFSL(SL,"arg",True) # '${arg}' on line 119, col 13
                        if _v is not None: write(_filter(_v, rawExpr='${arg}')) # from line 119, col 13.
                        write('''`` is an out direction argument.
''')
                if len(VFFSL(SL,"raises",True)) > 0: # generated from line 122, col 5
                    write('''
        Raises:
''')
                    for itm in VFFSL(SL,"raises",True): # generated from line 125, col 9
                        write('''            ''')
                        _v = VFFSL(SL,"itm",True)[0] # '$itm[0]' on line 126, col 13
                        if _v is not None: write(_filter(_v, rawExpr='$itm[0]')) # from line 126, col 13.
                        write(''': ``''')
                        _v = VFFSL(SL,"itm",True)[1] # '$itm[1]' on line 126, col 24
                        if _v is not None: write(_filter(_v, rawExpr='$itm[1]')) # from line 126, col 24.
                        write('''``
''')
                write('''        """
''')
        if VFFSL(SL,"is_properties",True): # generated from line 132, col 1
    ...
    def ''')
                ...
                write('''(self) -> ''')
                _v = VFFSL(SL,"property",True)['returns'] # "$property['returns']" on line 138, col 28
                if _v is not None: write(_filter(_v, rawExpr="$property['returns']")) # from line 138, col 28.
                write(''':
        """
''')
...
''')
        write("""
__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 159, col 13
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 159, col 13.
        write("""']
""")
