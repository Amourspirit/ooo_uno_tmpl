...
__CHEETAH_genTime__ = 1656800049.7101512
__CHEETAH_genTimestamp__ = 'Sat Jul  2 18:14:09 2022'
__CHEETAH_src__ = '_enum_base.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Jul  2 18:14:00 2022'
...
''')
        write('''    """
    __ooo_ns__: str = \'''')
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 57, col 24
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 57, col 24.
        write("""'
    __ooo_full_ns__: str = '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 58, col 29
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 58, col 29.
        write("""'
    ...
    def typeName(self) -> str:
        return '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 63, col 17
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 63, col 17.
        write("""'
...
""")
        for key in VFFSL(SL,"key_list",True): # generated from line 65, col 1
            ...
            write('''    ''')
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"key",True)) # '$self.get_safe_word($key)' on line 67, col 5
            if _v is not None: write(_filter(_v, rawExpr='$self.get_safe_word($key)')) # from line 67, col 5.
            write(""" = '""")
            _v = VFFSL(SL,"key",True) # '$key' on line 67, col 34
            if _v is not None: write(_filter(_v, rawExpr='$key')) # from line 67, col 34.
            write('''\'
    """
''')
            if isinstance(VFFSL(SL,"value",True), str): # generated from line 69, col 1
                write('''    ''')
                _v = VFFSL(SL,"value",True) # '$value' on line 70, col 5
                if _v is not None: write(_filter(_v, rawExpr='$value')) # from line 70, col 5.
                write('''
''')
            else: # generated from line 71, col 1
                for line in VFFSL(SL,"value",True): # generated from line 72, col 5
                    write('''    ''')
...
''')
        write("""
__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 79, col 13
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 79, col 13.
        write("""']
""")
