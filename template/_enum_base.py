...
__CHEETAH_genTime__ = 1640647022.6532972
__CHEETAH_genTimestamp__ = 'Mon Dec 27 18:17:02 2021'
__CHEETAH_src__ = '_enum_base.tmpl'
__CHEETAH_srcLastModified__ = 'Mon Dec 27 15:16:45 2021'
...
if (not TYPE_CHECKING) and UNO_ENVIRONMENT:
    ...
    from ''')
        _v = VFFSL(SL,"full_name",True) # '$full_name' on line 34, col 10
        if _v is not None: write(_filter(_v, rawExpr='$full_name')) # from line 34, col 10.
        write(''' import (''')
        _v = VFFSL(SL,"s_enum",True) # '$s_enum' on line 34, col 29
        if _v is not None: write(_filter(_v, rawExpr='$s_enum')) # from line 34, col 29.
        write(''')
...
''')
        write('''    """
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 52, col 5
            ...
            write(""" = '""")
            _v = VFFSL(SL,"key",True) # '$key' on line 54, col 13
            if _v is not None: write(_filter(_v, rawExpr='$key')) # from line 54, col 13.
            write('''\'
    """
''')
            if isinstance(VFFSL(SL,"value",True), str): # generated from line 56, col 1
                write('''    ''')
                _v = VFFSL(SL,"value",True) # '$value' on line 57, col 5
                if _v is not None: write(_filter(_v, rawExpr='$value')) # from line 57, col 5.
                write('''
''')
            else: # generated from line 58, col 1
                for line in VFFSL(SL,"value",True): # generated from line 59, col 5
                    write('''    ''')
...
def _dynamic_enum():
    ...
    global ''')
        _v = VFFSL(SL,"name",True) # '$name' on line 69, col 12
        if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 69, col 12.
        write("""
    ...
    if (not TYPE_CHECKING) and UNO_ENVIRONMENT:
        ...
        _dict = {
""")
        for key in VFFSL(SL,"key_list",True): # generated from line 77, col 1
            write('''            "''')
            _v = VFFSL(SL,"key",True) # '$key' on line 78, col 14
            if _v is not None: write(_filter(_v, rawExpr='$key')) # from line 78, col 14.
            write('''": ''')
            _v = VFFSL(SL,"key",True) # '${key}' on line 78, col 21
            if _v is not None: write(_filter(_v, rawExpr='${key}')) # from line 78, col 21.
            write(''',
''')
        write('''        }
        ''')
        _v = VFFSL(SL,"name",True) # '${name}' on line 81, col 9
        if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 81, col 9.
        write(""" = type('""")
        _v = VFFSL(SL,"name",True) # '$name' on line 81, col 25
        if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 81, col 25.
        write('''\', (object,), {
        ...
        for k, v in _dict.items():
            setattr(''')
        _v = VFFSL(SL,"name",True) # '${name}' on line 86, col 21
        if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 86, col 21.
        write(""", k, v)
...
__all__ = ['""")
        _v = VFFSL(SL,"name",True) # '$name' on line 91, col 13
        if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 91, col 13.
        write("""']
""")
