...
__CHEETAH_genTime__ = 1643227879.1223187
__CHEETAH_genTimestamp__ = 'Wed Jan 26 15:11:19 2022'
__CHEETAH_src__ = '_enum_base.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Jan 26 15:10:23 2022'
...
if (not TYPE_CHECKING) and UNO_ENVIRONMENT:
    ...
    from ''')
        _v = VFFSL(SL,"full_name",True) # '$full_name' on line 43, col 10
        if _v is not None: write(_filter(_v, rawExpr='$full_name')) # from line 43, col 10.
        write(''' import (''')
        _v = VFFSL(SL,"s_enum",True) # '$s_enum' on line 43, col 29
        if _v is not None: write(_filter(_v, rawExpr='$s_enum')) # from line 43, col 29.
        write(''')
...
class ''')
    ...
    """
''')
        if isinstance(VFFSL(SL,"desc",True), str): # generated from line 48, col 5
            write('''    ''')
            _v = VFFSL(SL,"desc",True) # '$desc' on line 49, col 5
            if _v is not None: write(_filter(_v, rawExpr='$desc')) # from line 49, col 5.
            write('''
''')
        else: # generated from line 50, col 5
            for line in VFFSL(SL,"desc",True): # generated from line 51, col 9
                write('''    ''')
...
''')
        write('''    """
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 61, col 5
            value = VFFSL(SL,"enum_dict",True)[VFFSL(SL,"key",True)]
            write('''    ''')
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"key",True)) # '$self.get_safe_word($key)' on line 63, col 5
            if _v is not None: write(_filter(_v, rawExpr='$self.get_safe_word($key)')) # from line 63, col 5.
            write(""" = '""")
            _v = VFFSL(SL,"key",True) # '$key' on line 63, col 34
            if _v is not None: write(_filter(_v, rawExpr='$key')) # from line 63, col 34.
            write('''\'
    """
''')
            if isinstance(VFFSL(SL,"value",True), str): # generated from line 65, col 1
                write('''    ''')
                _v = VFFSL(SL,"value",True) # '$value' on line 66, col 5
                if _v is not None: write(_filter(_v, rawExpr='$value')) # from line 66, col 5.
                write('''
''')
            else: # generated from line 67, col 1
                for line in VFFSL(SL,"value",True): # generated from line 68, col 5
                    write('''    ''')
...
def _dynamic_enum():
    ...
    global ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 78, col 12
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 78, col 12.
        write("""
...
""")
        for key in VFFSL(SL,"key_list",True): # generated from line 86, col 1
            ...
            write('''            "''')
            _v = VFFSL(SL,"safe_key",True) # '$safe_key' on line 88, col 14
            if _v is not None: write(_filter(_v, rawExpr='$safe_key')) # from line 88, col 14.
            write('''": ''')
            _v = VFFSL(SL,"safe_key",True) # '${safe_key}' on line 88, col 26
            if _v is not None: write(_filter(_v, rawExpr='${safe_key}')) # from line 88, col 26.
            write(''',
''')
        write('''        }
        ''')
...
__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 101, col 13
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 101, col 13.
        write("""']
""")
