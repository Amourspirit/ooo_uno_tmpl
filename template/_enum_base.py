...
__CHEETAH_genTime__ = 1684198238.9487033
__CHEETAH_genTimestamp__ = 'Mon May 15 20:50:38 2023'
__CHEETAH_src__ = '_enum_base.tmpl'
__CHEETAH_srcLastModified__ = 'Mon May 15 20:50:32 2023'
...
''')
        if isinstance(VFFSL(SL,"desc",True), str) and VFFSL(SL,"desc",True): # generated from line 44, col 5
            write('''    ''')
...
''')
            ...
            for line in VFFSL(SL,"desc",True): # generated from line 47, col 9
                if VFFSL(SL,"line",True): # generated from line 48, col 13
                    write('''    ''')
...
''')
        write('''    """
    __ooo_ns__: str = \'''')
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 59, col 24
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 59, col 24.
        write("""'
    __ooo_full_ns__: str = '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 60, col 29
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 60, col 29.
        write("""'
    ...
    def typeName(self) -> str:
        return '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 65, col 17
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 65, col 17.
        write("""'

""")
        for key in VFFSL(SL,"key_list",True): # generated from line 67, col 1
            value = VFFSL(SL,"enum_dict",True)[VFFSL(SL,"key",True)]
            write('''    ''')
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"key",True)) # '$self.get_safe_word($key)' on line 69, col 5
            if _v is not None: write(_filter(_v, rawExpr='$self.get_safe_word($key)')) # from line 69, col 5.
            write(""" = '""")
            _v = VFFSL(SL,"key",True) # '$key' on line 69, col 34
            if _v is not None: write(_filter(_v, rawExpr='$key')) # from line 69, col 34.
            write('''\'
    """
''')
            if isinstance(VFFSL(SL,"value",True), str): # generated from line 71, col 1
                write('''    ''')
                _v = VFFSL(SL,"value",True) # '$value' on line 72, col 5
                if _v is not None: write(_filter(_v, rawExpr='$value')) # from line 72, col 5.
                write('''
''')
            else: # generated from line 73, col 1
                for line in VFFSL(SL,"value",True): # generated from line 74, col 5
                    write('''    ''')
