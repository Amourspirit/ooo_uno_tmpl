...
__CHEETAH_genTime__ = 1685022405.9075506
__CHEETAH_genTimestamp__ = 'Thu May 25 09:46:45 2023'
__CHEETAH_src__ = '_enum_base.tmpl'
__CHEETAH_srcLastModified__ = 'Thu May 25 09:46:26 2023'
...
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 69, col 1
            ...
            write(''' = "''')
            _v = VFFSL(SL,"key",True) # '$key' on line 71, col 34
            if _v is not None: write(_filter(_v, rawExpr='$key')) # from line 71, col 34.
            write('''"
    """
''')
