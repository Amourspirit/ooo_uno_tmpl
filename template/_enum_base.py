...
__CHEETAH_genTime__ = 1642286034.2658627
__CHEETAH_genTimestamp__ = 'Sat Jan 15 17:33:54 2022'
__CHEETAH_src__ = '_enum_base.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Jan 15 17:32:50 2022'
...
if (not TYPE_CHECKING) and UNO_ENVIRONMENT:
    ...
    from ''')
        _v = VFFSL(SL,"full_name",True) # '$full_name' on line 41, col 10
        if _v is not None: write(_filter(_v, rawExpr='$full_name')) # from line 41, col 10.
        write(''' import (''')
        _v = VFFSL(SL,"s_enum",True) # '$s_enum' on line 41, col 29
        if _v is not None: write(_filter(_v, rawExpr='$s_enum')) # from line 41, col 29.
        write(''')
...
''')
        write('''    """
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 59, col 5
            value = VFFSL(SL,"enum_dict",True)[VFFSL(SL,"key",True)]
            write('''    ''')
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"key",True)) # '$self.get_safe_word($key)' on line 61, col 5
            if _v is not None: write(_filter(_v, rawExpr='$self.get_safe_word($key)')) # from line 61, col 5.
            write(""" = '""")
            _v = VFFSL(SL,"key",True) # '$key' on line 61, col 34
            if _v is not None: write(_filter(_v, rawExpr='$key')) # from line 61, col 34.
            write('''\'
    """
''')
            if isinstance(VFFSL(SL,"value",True), str): # generated from line 63, col 1
                write('''    ''')
                _v = VFFSL(SL,"value",True) # '$value' on line 64, col 5
                if _v is not None: write(_filter(_v, rawExpr='$value')) # from line 64, col 5.
                write('''
''')
            else: # generated from line 65, col 1
                for line in VFFSL(SL,"value",True): # generated from line 66, col 5
                    write('''    ''')
...
def _dynamic_enum():
    ...
    global ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 76, col 12
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 76, col 12.
        write("""
    ...
    if (not TYPE_CHECKING) and UNO_ENVIRONMENT:
        ...
        _dict = {
""")
        for key in VFFSL(SL,"key_list",True): # generated from line 84, col 1
            safe_key = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"key",True))
            write('''            "''')
            _v = VFFSL(SL,"safe_key",True) # '$safe_key' on line 86, col 14
            if _v is not None: write(_filter(_v, rawExpr='$safe_key')) # from line 86, col 14.
            write('''": ''')
            _v = VFFSL(SL,"safe_key",True) # '${safe_key}' on line 86, col 26
            if _v is not None: write(_filter(_v, rawExpr='${safe_key}')) # from line 86, col 26.
            write(''',
''')
        write('''        }
        ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 89, col 9
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 89, col 9.
        write(""" = type('""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 89, col 28
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 89, col 28.
        write('''\', (object,), {
        ...
        for k, v in _dict.items():
            setattr(''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 94, col 21
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 94, col 21.
        write(""", k, v)
...
__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 99, col 13
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 99, col 13.
        write("""']
""")
