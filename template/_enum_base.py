...
__CHEETAH_genTime__ = 1640895879.784896
__CHEETAH_genTimestamp__ = 'Thu Dec 30 15:24:39 2021'
__CHEETAH_src__ = '_enum_base.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Dec 30 15:24:36 2021'
...
class ''')
        _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 38, col 7
        if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 38, col 7.
        write('''(Enum):
    """
''')
...
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 53, col 5
            ...
            write('''    ''')
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"key",True)) # '$self.get_safe_word($key)' on line 55, col 5
            if _v is not None: write(_filter(_v, rawExpr='$self.get_safe_word($key)')) # from line 55, col 5.
            write(""" = '""")
            _v = VFFSL(SL,"key",True) # '$key' on line 55, col 34
            if _v is not None: write(_filter(_v, rawExpr='$key')) # from line 55, col 34.
            write('''\'
    """
''')
...
def _dynamic_enum():
    ...
    global ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 70, col 12
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 70, col 12.
        write("""
...
""")
        for key in VFFSL(SL,"key_list",True): # generated from line 78, col 1
            ...
            write('''            "''')
            _v = VFFSL(SL,"safe_key",True) # '$safe_key' on line 80, col 14
            if _v is not None: write(_filter(_v, rawExpr='$safe_key')) # from line 80, col 14.
            write('''": ''')
            _v = VFFSL(SL,"safe_key",True) # '${safe_key}' on line 80, col 26
            if _v is not None: write(_filter(_v, rawExpr='${safe_key}')) # from line 80, col 26.
            write(''',
''')
        write('''        }
        ''')
        ...
        write(""" = type('""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 83, col 28
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 83, col 28.
        write('''\', (object,), {
        ...
        for k, v in _dict.items():
            setattr(''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 88, col 21
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 88, col 21.
        write(""", k, v)
...
__all__ = ['""")
        _v = VFFSL(SL,"name",True) # '$name' on line 93, col 13
        if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 93, col 13.
        write("""']
""")
