...
__CHEETAH_genTime__ = 1650153030.6400204
__CHEETAH_genTimestamp__ = 'Sat Apr 16 19:50:30 2022'
__CHEETAH_src__ = '_enum_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Apr 16 19:50:25 2022'
...
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 58, col 1
            # $self.get_safe_word($key)$self.get_typing($self.get_safe_word($key))
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"key",True)) # '$self.get_safe_word($key)' on line 60, col 1
            if _v is not None: write(_filter(_v, rawExpr='$self.get_safe_word($key)')) # from line 60, col 1.
            write(""": 'UnoEnum'
""")
...
''')
            if isinstance(VFFSL(SL,"value",True), str): # generated from line 63, col 1
                _v = VFFSL(SL,"value",True) # '$value' on line 64, col 1
                if _v is not None: write(_filter(_v, rawExpr='$value')) # from line 64, col 1.
                write('''
''')
            else: # generated from line 65, col 1
                for line in VFFSL(SL,"value",True): # generated from line 66, col 5
                    _v = VFFSL(SL,"line",True) # '$line' on line 67, col 1
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 67, col 1.
                    write('''
''')
            write('''"""
''')
