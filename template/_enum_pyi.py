...
__CHEETAH_genTime__ = 1684801426.4404967
__CHEETAH_genTimestamp__ = 'Mon May 22 20:23:46 2023'
__CHEETAH_src__ = '_enum_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Mon May 22 20:23:39 2023'
...
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 41, col 1
            write('''    ''')
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"key",True)) # '$self.get_safe_word($key)' on line 42, col 5
            if _v is not None: write(_filter(_v, rawExpr='$self.get_safe_word($key)')) # from line 42, col 5.
            write(''': UnoEnumProto
''')
        write('''
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 45, col 1
            # $self.get_safe_word($key)$self.get_typing($self.get_safe_word($key))
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"key",True)) # '$self.get_safe_word($key)' on line 47, col 1
            if _v is not None: write(_filter(_v, rawExpr='$self.get_safe_word($key)')) # from line 47, col 1.
            write(''': ''')
...
''')
            ...
            write('''"""
''')
            if isinstance(VFFSL(SL,"value",True), str): # generated from line 50, col 5
                _v = VFFSL(SL,"indt",True) # '${indt}' on line 51, col 1
                if _v is not None: write(_filter(_v, rawExpr='${indt}')) # from line 51, col 1.
                _v = VFFSL(SL,"value",True) # '$value' on line 51, col 8
                if _v is not None: write(_filter(_v, rawExpr='$value')) # from line 51, col 8.
                write('''
''')
            else: # generated from line 52, col 5
                for line in VFFSL(SL,"value",True): # generated from line 53, col 9
                    _v = VFFSL(SL,"line",True) # '$line' on line 54, col 1
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 54, col 1.
                    write('''
''')
            write('''"""
''')
