...
__CHEETAH_genTime__ = 1652557236.5287688
__CHEETAH_genTimestamp__ = 'Sat May 14 15:40:36 2022'
__CHEETAH_src__ = '_enum_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Sat May 14 15:40:33 2022'
...
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 68, col 1
            ...
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"key",True)) # '$self.get_safe_word($key)' on line 70, col 8
            if _v is not None: write(_filter(_v, rawExpr='$self.get_safe_word($key)')) # from line 70, col 8.
            write(""": 'uno.Enum'
""")
...
''')
            if isinstance(VFFSL(SL,"value",True), str): # generated from line 73, col 1
                ...
                _v = VFFSL(SL,"value",True) # '$value' on line 74, col 8
                if _v is not None: write(_filter(_v, rawExpr='$value')) # from line 74, col 8.
                write('''
''')
