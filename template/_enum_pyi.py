...
__CHEETAH_genTime__ = 1685021934.4071665
__CHEETAH_genTimestamp__ = 'Thu May 25 09:38:54 2023'
__CHEETAH_src__ = '_enum_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Thu May 25 09:37:21 2023'
...
class ''')
    ...
    """Protocol for ''')
        _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 43, col 21
        if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 43, col 21.
        write('''"""

    @property
    def typeName(self) -> Literal["''')
        _v = VFFSL(SL,"fullname",True) # '${fullname}' on line 46, col 36
        if _v is not None: write(_filter(_v, rawExpr='${fullname}')) # from line 46, col 36.
        write('''"]:
        ...
    value: Any
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 49, col 1
            write('''    ''')
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"key",True)) # '$self.get_safe_word($key)' on line 50, col 5
            if _v is not None: write(_filter(_v, rawExpr='$self.get_safe_word($key)')) # from line 50, col 5.
            write(''': ''')
            _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 50, col 32
            if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 50, col 32.
            write('''Proto
''')
        write('''
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 53, col 1
            ...
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"key",True)) # '$self.get_safe_word($key)' on line 55, col 1
            if _v is not None: write(_filter(_v, rawExpr='$self.get_safe_word($key)')) # from line 55, col 1.
            write(''': ''')
...
''')
            ...
            write('''"""
''')
            if isinstance(VFFSL(SL,"value",True), str): # generated from line 58, col 5
                _v = VFFSL(SL,"indt",True) # '${indt}' on line 59, col 1
                if _v is not None: write(_filter(_v, rawExpr='${indt}')) # from line 59, col 1.
                _v = VFFSL(SL,"value",True) # '$value' on line 59, col 8
                if _v is not None: write(_filter(_v, rawExpr='$value')) # from line 59, col 8.
                write('''
''')
            else: # generated from line 60, col 5
                for line in VFFSL(SL,"value",True): # generated from line 61, col 9
                    _v = VFFSL(SL,"line",True) # '$line' on line 62, col 1
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 62, col 1.
                    write('''
''')
            write('''"""
''')
