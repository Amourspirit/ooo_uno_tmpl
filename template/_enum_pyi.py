...
__CHEETAH_genTime__ = 1649882819.2220907
__CHEETAH_genTimestamp__ = 'Wed Apr 13 16:46:59 2022'
__CHEETAH_src__ = '_enum_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Apr 13 16:46:43 2022'
...
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 58, col 1
            ...
            _v = VFN(VFFSL(SL,"self",True),"get_typing",False)(VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"key",True))) # '$self.get_typing($self.get_safe_word($key))' on line 59, col 30
            if _v is not None: write(_filter(_v, rawExpr='$self.get_typing($self.get_safe_word($key))')) # from line 59, col 30.
            write('''
''')
...
''')
        write("""
__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 72, col 13
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 72, col 13.
        write("""']
""")
