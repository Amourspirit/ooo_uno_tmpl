...
__CHEETAH_genTime__ = 1684277839.7235336
__CHEETAH_genTimestamp__ = 'Tue May 16 18:57:19 2023'
__CHEETAH_src__ = '_enum_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Tue May 16 18:57:16 2023'
...
class ''')
            ...
            write('''(uno.Enum):
''')
        _v = VFFSL(SL,"indt",True) # '${indt}' on line 50, col 1
        if _v is not None: write(_filter(_v, rawExpr='${indt}')) # from line 50, col 1.
        write('''"""
''')
...
''')
        if isinstance(VFFSL(SL,"desc",True), str) and VFFSL(SL,"desc",True): # generated from line 53, col 5
            _v = VFFSL(SL,"indt",True) # '${indt}' on line 54, col 1
            if _v is not None: write(_filter(_v, rawExpr='${indt}')) # from line 54, col 1.
            _v = VFFSL(SL,"desc",True) # '${desc}' on line 54, col 8
            if _v is not None: write(_filter(_v, rawExpr='${desc}')) # from line 54, col 8.
            write('''
''')
        else: # generated from line 55, col 5
            for line in VFFSL(SL,"desc",True): # generated from line 56, col 9
                if VFFSL(SL,"line",True): # generated from line 57, col 13
                    ...
                    write('''
''')
        if VFFSL(SL,"link",True): # generated from line 62, col 1
            write('''
''')
...
''')
            ...
            write('''    `API ''')
            _v = VFFSL(SL,"name",True) # '$name' on line 65, col 17
            if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 65, col 17.
            write(''' <''')
            _v = VFFSL(SL,"link",True) # '$link' on line 65, col 24
            if _v is not None: write(_filter(_v, rawExpr='$link')) # from line 65, col 24.
            write('''>`_
''')
...
''')
        ...
        write("""typeName: str = '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 69, col 25
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 69, col 25.
        write("""'

""")
        for key in VFFSL(SL,"key_list",True): # generated from line 71, col 1
            ...
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"key",True)) # '$self.get_safe_word($key)' on line 73, col 8
            if _v is not None: write(_filter(_v, rawExpr='$self.get_safe_word($key)')) # from line 73, col 8.
            write(''': ''')
            _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 73, col 35
            if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 73, col 35.
            write(''' = ...
''')
...
''')
            if isinstance(VFFSL(SL,"value",True), str): # generated from line 76, col 1
                ...
                _v = VFFSL(SL,"value",True) # '$value' on line 77, col 8
                if _v is not None: write(_filter(_v, rawExpr='$value')) # from line 77, col 8.
                write('''
''')
