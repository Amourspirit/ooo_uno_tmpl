...
__CHEETAH_genTime__ = 1650396782.6778708
__CHEETAH_genTimestamp__ = 'Tue Apr 19 15:33:02 2022'
__CHEETAH_src__ = '_enum_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Tue Apr 19 15:33:00 2022'
...
''')
        if isinstance(VFFSL(SL,"desc",True), str): # generated from line 43, col 5
            _v = VFFSL(SL,"desc",True) # '$desc' on line 44, col 1
            if _v is not None: write(_filter(_v, rawExpr='$desc')) # from line 44, col 1.
            write('''
''')
        else: # generated from line 45, col 5
            for line in VFFSL(SL,"desc",True): # generated from line 46, col 9
                _v = VFFSL(SL,"line",True) # '$line' on line 47, col 1
                if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 47, col 1.
                write('''
''')
...
See Also:
    `API ''')
            _v = VFFSL(SL,"name",True) # '$name' on line 53, col 10
            if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 53, col 10.
            write(''' <''')
            _v = VFFSL(SL,"link",True) # '$link' on line 53, col 17
            if _v is not None: write(_filter(_v, rawExpr='$link')) # from line 53, col 17.
            write('''>`_
''')
        write('''"""
...
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 57, col 1
            ...
            _v = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"key",True)) # '$self.get_safe_word($key)' on line 59, col 1
            if _v is not None: write(_filter(_v, rawExpr='$self.get_safe_word($key)')) # from line 59, col 1.
            write(""": 'uno.Enum'
""")
...
''')
            if isinstance(VFFSL(SL,"value",True), str): # generated from line 62, col 1
                _v = VFFSL(SL,"value",True) # '$value' on line 63, col 1
                if _v is not None: write(_filter(_v, rawExpr='$value')) # from line 63, col 1.
                write('''
''')
            else: # generated from line 64, col 1
                for line in VFFSL(SL,"value",True): # generated from line 65, col 5
                    _v = VFFSL(SL,"line",True) # '$line' on line 66, col 1
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 66, col 1.
                    write('''
''')
            write('''"""
''')
