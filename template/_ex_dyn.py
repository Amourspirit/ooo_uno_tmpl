...
__CHEETAH_genTime__ = 1684880550.531153
__CHEETAH_genTimestamp__ = 'Tue May 23 18:22:30 2023'
__CHEETAH_src__ = '_ex_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Tue May 23 18:18:25 2023'
...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    if TYPE_CHECKING:
        from ''')
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 77, col 14
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 77, col 14.
        write(''' import ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 77, col 32
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 77, col 32.
        write(''' as ''')
        ...
        ''')
        _v = VFN(VFFSL(SL,"self",True),"get_rel_import",False)(in_str=VFFSL(SL,"uno_obj_in",True), ns=VFFSL(SL,"uno_obj_ns",True)) # '$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)' on line 79, col 9
        if _v is not None: write(_filter(_v, rawExpr='$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)')) # from line 79, col 9.
        write(''' as ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 79, col 69
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 79, col 69.
        write("""
