...
__CHEETAH_genTime__ = 1644754941.450617
__CHEETAH_genTimestamp__ = 'Sun Feb 13 07:22:21 2022'
__CHEETAH_src__ = '_ex_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Sun Feb 13 07:21:38 2022'
...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_ex() -> None:
        ...
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 54, col 34
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 54, col 34.
        write(''' using uno
        global ''')
        ...
        def _set_fn_attr(ex):
            type_name = '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 58, col 26
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 58, col 26.
        write("""'
        ...
        def _set_attr(ex):
            ex.__dict__['__ooo_ns__'] = '""")
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 64, col 42
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 64, col 42.
        write("""'
            ex.__dict__['__ooo_full_ns__'] = '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 65, col 47
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 65, col 47.
        write("""'
            ex.__dict__['__ooo_type_name__'] = 'exception'

        """)
        _v = VFN(VFFSL(SL,"self",True),"get_dyn_fn",False)() # '$self.get_dyn_fn()' on line 68, col 9
        if _v is not None: write(_filter(_v, rawExpr='$self.get_dyn_fn()')) # from line 68, col 9.
        write("""
            ns = '""")
        _v = VFFSL(SL,"fullname",True) # '${fullname}' on line 69, col 19
        if _v is not None: write(_filter(_v, rawExpr='${fullname}')) # from line 69, col 19.
        write("""'
...
""")
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 71, col 1
            ...
            write(""" is UNO_NONE:
                if getattr(ex, '""")
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 77, col 33
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 77, col 33.
            write("""') != """)
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 77, col 48
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 77, col 48.
            write(""":
                    setattr(ex, '""")
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 78, col 34
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 78, col 34.
            write("""', """)
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 78, col 46
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 78, col 46.
            write(''')
''')
        if self.is_parent: # generated from line 80, col 1
...
''')
    ...
    ''')
        _v = VFN(VFFSL(SL,"self",True),"get_rel_import",False)(in_str=VFFSL(SL,"uno_obj_in",True), ns=VFFSL(SL,"uno_obj_ns",True)) # '$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)' on line 95, col 5
        if _v is not None: write(_filter(_v, rawExpr='$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)')) # from line 95, col 5.
        write(''' as ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 95, col 65
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 95, col 65.
        write("""
    
__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 97, col 13
        if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 97, col 13.
        write("""']
""")
