...
__CHEETAH_genTime__ = 1644265116.7916977
__CHEETAH_genTimestamp__ = 'Mon Feb  7 15:18:36 2022'
__CHEETAH_src__ = '_ex_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Mon Feb  7 15:17:40 2022'
...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    def _dynamic_exception() -> None:
        ...
        write(""" = unoclass('""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 54, col 32
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 54, col 32.
        write("""')
        setattr(""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 55, col 17
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 55, col 17.
        write(""", ' __ooo_ns__', '""")
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 55, col 45
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 55, col 45.
        write("""')
        setattr(""")
        ...
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 56, col 50
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 56, col 50.
        write("""')
        setattr(""")
