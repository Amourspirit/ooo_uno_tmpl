...
__CHEETAH_genTime__ = 1643848937.6082475
__CHEETAH_genTimestamp__ = 'Wed Feb  2 19:42:17 2022'
__CHEETAH_src__ = '_ex_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Feb  2 19:36:09 2022'
...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    def _dynamic_exception() -> None:
        ...
        global ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 49, col 16
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 49, col 16.
        write('''
        ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 50, col 9
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 50, col 9.
        write(""" = unoclass(
            '""")
        _v = VFFSL(SL,"full_name",True) # '${full_name}' on line 51, col 14
        if _v is not None: write(_filter(_v, rawExpr='${full_name}')) # from line 51, col 14.
        write("""')
