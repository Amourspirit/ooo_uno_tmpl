...
__CHEETAH_genTime__ = 1643836318.0465546
__CHEETAH_genTimestamp__ = 'Wed Feb  2 16:11:58 2022'
__CHEETAH_src__ = '_ex_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Feb  2 16:11:53 2022'
...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    def _dynamic_exception() -> None:
        ...
        global ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 48, col 16
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 48, col 16.
        write('''
        ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 49, col 9
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 49, col 9.
        write(""" = unoclass(
            '""")
        _v = VFFSL(SL,"full_name",True) # '${full_name}' on line 50, col 14
        if _v is not None: write(_filter(_v, rawExpr='${full_name}')) # from line 50, col 14.
        write("""')

    _dynamic_exception()
else:
    """)
        _v = VFN(VFFSL(SL,"self",True),"get_rel_import",False)(in_str=VFFSL(SL,"uno_obj_in",True), ns=VFFSL(SL,"uno_obj_ns",True)) # '$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)' on line 54, col 5
        if _v is not None: write(_filter(_v, rawExpr='$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)')) # from line 54, col 5.
        write(''' as ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 54, col 65
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 54, col 65.
        write("""
