...
__CHEETAH_genTime__ = 1644274912.1359024
__CHEETAH_genTimestamp__ = 'Mon Feb  7 18:01:52 2022'
__CHEETAH_src__ = '_ex_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Mon Feb  7 18:01:36 2022'
...
if not TYPE_CHECKING and _DYNAMIC:
    from ''')
        ...
        write("""
    setattr(Exception, '__ooo_ns__', '""")
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 51, col 39
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 51, col 39.
        write("""')
    setattr(Exception, '__ooo_full_ns__', '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 52, col 44
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 52, col 44.
        write("""')
