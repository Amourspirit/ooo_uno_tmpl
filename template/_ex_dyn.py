...
__CHEETAH_genTime__ = 1645554358.6885717
__CHEETAH_genTimestamp__ = 'Tue Feb 22 13:25:58 2022'
__CHEETAH_src__ = '_ex_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Tue Feb 22 13:24:31 2022'
...
''')
        if VFFSL(SL,"is_sorted",True): # generated from line 55, col 1
            ...
            write(''', "__class__", None) == self.__class__:
                orig_init(self, ''')
            _v = VFFSL(SL,"sorted_first",True) # '$sorted_first' on line 58, col 33
            if _v is not None: write(_filter(_v, rawExpr='$sorted_first')) # from line 58, col 33.
            write(''')
                return
            else:
                orig_init(self)
