...
__CHEETAH_genTime__ = 1644751513.8853018
__CHEETAH_genTimestamp__ = 'Sun Feb 13 06:25:13 2022'
__CHEETAH_src__ = '_ex_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Sun Feb 13 06:24:26 2022'
...
""")
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 65, col 1
            ...
            write(""" is UNO_NONE:
                if getattr(ex, '""")
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 71, col 33
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 71, col 33.
            write("""') != """)
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 71, col 48
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 71, col 48.
            write(""":
                    setattr(ex, '""")
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 72, col 34
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 72, col 34.
            write("""', """)
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 72, col 46
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 72, col 46.
            write(''')
''')
