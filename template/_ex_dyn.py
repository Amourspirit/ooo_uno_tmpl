...
__CHEETAH_genTime__ = 1644690945.6797912
__CHEETAH_genTimestamp__ = 'Sat Feb 12 13:35:45 2022'
__CHEETAH_src__ = '_ex_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Feb 12 13:35:42 2022'
...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_ex() -> None:
        ...
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 58, col 42
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 58, col 42.
        write("""'
            ex.__dict__['__ooo_full_ns__'] = '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 59, col 47
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 59, col 47.
        write("""'
            ex.__dict__['__ooo_type_name__'] = 'exception'

        """)
        _v = VFN(VFFSL(SL,"self",True),"get_dyn_fn",False)() # '$self.get_dyn_fn()' on line 62, col 9
        if _v is not None: write(_filter(_v, rawExpr='$self.get_dyn_fn()')) # from line 62, col 9.
        write("""
            ns = '""")
        _v = VFFSL(SL,"fullname",True) # '${fullname}' on line 63, col 19
        if _v is not None: write(_filter(_v, rawExpr='${fullname}')) # from line 63, col 19.
        write("""'
...
""")
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 65, col 1
            ...
            write("""            if getattr(ex, '""")
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 70, col 29
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 70, col 29.
            write("""') != """)
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 70, col 44
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 70, col 44.
            write(""":
                setattr(ex, '""")
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 71, col 30
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 71, col 30.
            write("""', """)
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 71, col 42
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 71, col 42.
            write(''')
''')
        write('''
