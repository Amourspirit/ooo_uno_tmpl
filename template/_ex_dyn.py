...
__CHEETAH_genTime__ = 1644339359.4201732
__CHEETAH_genTimestamp__ = 'Tue Feb  8 11:55:59 2022'
__CHEETAH_src__ = '_ex_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Tue Feb  8 11:54:35 2022'
...
if not TYPE_CHECKING and _DYNAMIC:
    from ''')
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 50, col 10
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 50, col 10.
        write(''' import ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 50, col 28
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 50, col 28.
        write('''
    setattr(''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 51, col 13
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 51, col 13.
        write(""", '__ooo_ns__', '""")
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 51, col 40
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 51, col 40.
        write("""')
    setattr(""")
        ...
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 52, col 45
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 52, col 45.
        write("""')
    setattr(""")
        ...
        write(""", '__ooo_type_name__', 'exception')
else:
    """)
        _v = VFN(VFFSL(SL,"self",True),"get_rel_import",False)(in_str=VFFSL(SL,"uno_obj_in",True), ns=VFFSL(SL,"uno_obj_ns",True)) # '$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)' on line 55, col 5
        if _v is not None: write(_filter(_v, rawExpr='$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)')) # from line 55, col 5.
        write(''' as ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 55, col 65
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 55, col 65.
        write("""
    
__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 57, col 13
        if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 57, col 13.
        write("""']
""")
