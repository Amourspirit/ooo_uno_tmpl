...
__CHEETAH_genTime__ = 1645551139.0724618
__CHEETAH_genTimestamp__ = 'Tue Feb 22 12:32:19 2022'
__CHEETAH_src__ = '_ex_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Tue Feb 22 12:31:57 2022'
...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        ''')
        _v = VFN(VFFSL(SL,"self",True),"get_dyn_fn",False)(fn_name='init') # "$self.get_dyn_fn(fn_name='init')" on line 54, col 9
        if _v is not None: write(_filter(_v, rawExpr="$self.get_dyn_fn(fn_name='init')")) # from line 54, col 9.
        write('''
''')
        if VFFSL(SL,"is_sorted",True): # generated from line 55, col 1
            sorted_first = VFN(VFFSL(SL,"self",True),"get_dyn_constructor_args_lst",False)(add_default=False)[0]
            write('''            if getattr(''')
            _v = VFFSL(SL,"sorted_first",True) # '$sorted_first' on line 57, col 24
            if _v is not None: write(_filter(_v, rawExpr='$sorted_first')) # from line 57, col 24.
            write(''', "__class__", None) == self.__class__:
                orig_init(''')
            _v = VFFSL(SL,"sorted_first",True) # '$sorted_first' on line 58, col 27
            if _v is not None: write(_filter(_v, rawExpr='$sorted_first')) # from line 58, col 27.
            write(''')
                return
            else:
                orig_init(self)
...
''')
        for i, tpl in enumerate(VFFSL(SL,"sorted",True)): # generated from line 65, col 1
            index = tpl[1]
            ...
            write('''            if not ''')
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 70, col 20
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 70, col 20.
            write(""" is UNO_NONE:
                if getattr(self, '""")
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 71, col 35
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 71, col 35.
            write("""') != """)
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 71, col 50
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 71, col 50.
            write(""":
                    setattr(self, '""")
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 72, col 36
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 72, col 36.
            write("""', """)
            _v = VFFSL(SL,"itm_name",True) # '$itm_name' on line 72, col 48
            if _v is not None: write(_filter(_v, rawExpr='$itm_name')) # from line 72, col 48.
            write(''')
''')
        if self.is_parent: # generated from line 74, col 1
...
''')
        ...
        ex.__ooo_ns__ = '""")
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 84, col 26
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 84, col 26.
        write("""'
    ...
    """)
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 91, col 5
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 91, col 5.
        write(''' = _get_class()

else:
    ''')
        _v = VFN(VFFSL(SL,"self",True),"get_rel_import",False)(in_str=VFFSL(SL,"uno_obj_in",True), ns=VFFSL(SL,"uno_obj_ns",True)) # '$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)' on line 94, col 5
        if _v is not None: write(_filter(_v, rawExpr='$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)')) # from line 94, col 5.
        write(''' as ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 94, col 65
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 94, col 65.
        write("""

__all__ = ['""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 96, col 13
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 96, col 13.
        write("""']
""")
