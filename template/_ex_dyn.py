...
__CHEETAH_genTime__ = 1644527879.416669
__CHEETAH_genTimestamp__ = 'Thu Feb 10 16:17:59 2022'
__CHEETAH_src__ = '_ex_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Feb 10 16:17:41 2022'
...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_ex() -> None:
        ...
        write("""'
            ex = uno.createUnoStruct(ns, *args, **kwargs)
            _set_attr(ex)
            return ex
        """)
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 65, col 9
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 65, col 9.
        write(''' = _ex_init

    _dynamic_ex()
else:
    ''')
        _v = VFN(VFFSL(SL,"self",True),"get_rel_import",False)(in_str=VFFSL(SL,"uno_obj_in",True), ns=VFFSL(SL,"uno_obj_ns",True)) # '$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)' on line 69, col 5
        if _v is not None: write(_filter(_v, rawExpr='$self.get_rel_import(in_str=$uno_obj_in, ns=$uno_obj_ns)')) # from line 69, col 5.
        write(''' as ''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 69, col 65
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 69, col 65.
        write("""
