...
__CHEETAH_genTime__ = 1646878076.0322824
__CHEETAH_genTimestamp__ = 'Wed Mar  9 21:07:56 2022'
__CHEETAH_src__ = '_ex_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Mar  9 21:07:52 2022'
...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        ordered_keys = (''')
        _v = VFN(VFFSL(SL,"self",True),"get_nt_names_all_str",False)() # '$self.get_nt_names_all_str()' on line 53, col 25
        if _v is not None: write(_filter(_v, rawExpr='$self.get_nt_names_all_str()')) # from line 53, col 25.
        write(''')
        ...
        type_name = \'''')
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 63, col 22
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 63, col 22.
        write("""'
        ex = uno.getClass(type_name)
        ex.__ooo_ns__ = '""")
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 65, col 26
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 65, col 26.
        write("""'
