...
__CHEETAH_genTime__ = 1644448687.7254624
__CHEETAH_genTimestamp__ = 'Wed Feb  9 18:18:07 2022'
__CHEETAH_src__ = '_ex_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Feb  9 18:00:57 2022'
...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_ex() -> None:
        ...
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 56, col 42
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 56, col 42.
        write("""'
            ex.__dict__['__ooo_full_ns__'] = '""")
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 57, col 47
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 57, col 47.
        write("""'
