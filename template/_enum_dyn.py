...
__CHEETAH_genTime__ = 1684286198.0788105
__CHEETAH_genTimestamp__ = 'Tue May 16 21:16:38 2023'
__CHEETAH_src__ = '_enum_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Tue May 16 21:16:24 2023'
...
if TYPE_CHECKING:
    ...
    class ''')
        _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 53, col 11
        if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 53, col 11.
        write('''(uno.Enum):
        """
        Enum Class
...
''')
        if isinstance(VFFSL(SL,"desc",True), str) and VFFSL(SL,"desc",True): # generated from line 57, col 5
            write('''        ''')
            _v = VFFSL(SL,"desc",True) # '$desc' on line 58, col 9
            if _v is not None: write(_filter(_v, rawExpr='$desc')) # from line 58, col 9.
            write('''
''')
            ...
            for line in VFFSL(SL,"desc",True): # generated from line 60, col 9
                if VFFSL(SL,"line",True): # generated from line 61, col 13
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 62, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 62, col 9.
                    write('''
''')
        ...
        See Also:
            `API ''')
            _v = VFFSL(SL,"name",True) # '$name' on line 69, col 18
            if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 69, col 18.
            write(''' <''')
            _v = VFFSL(SL,"link",True) # '$link' on line 69, col 25
            if _v is not None: write(_filter(_v, rawExpr='$link')) # from line 69, col 25.
            write('''>`_
''')
        write('''        """
        __ooo_ns__: str = ...
...
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 80, col 1
            ...
            write('''        ''')
            _v = VFFSL(SL,"key",True) # '${key}' on line 83, col 9
            if _v is not None: write(_filter(_v, rawExpr='${key}')) # from line 83, col 9.
            write(''': ''')
            _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 83, col 17
            if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 83, col 17.
            write(''' = ...
        """
''')
            if isinstance(VFFSL(SL,"value",True), str): # generated from line 85, col 1
                write('''        ''')
                _v = VFFSL(SL,"value",True) # '$value' on line 86, col 9
                if _v is not None: write(_filter(_v, rawExpr='$value')) # from line 86, col 9.
                write('''
''')
            else: # generated from line 87, col 1
                for line in VFFSL(SL,"value",True): # generated from line 88, col 5
                    write('''        ''')
...
''')
    ...
    from ''')
        _v = VFFSL(SL,"uno_enum_namespace",True) # '$uno_enum_namespace' on line 97, col 10
        if _v is not None: write(_filter(_v, rawExpr='$uno_enum_namespace')) # from line 97, col 10.
        write(''' import UnoEnumMeta
    class ''')
        _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 98, col 11
        if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 98, col 11.
        write('''(metaclass=UnoEnumMeta, type_name="''')
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 98, col 58
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 98, col 58.
        write('''", name_space="''')
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 98, col 82
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 98, col 82.
        write('''"):
        """Dynamically created class that represents ``''')
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 99, col 56
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 99, col 56.
