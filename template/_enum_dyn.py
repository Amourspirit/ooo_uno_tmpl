...
__CHEETAH_genTime__ = 1644084756.0900152
__CHEETAH_genTimestamp__ = 'Sat Feb  5 13:12:36 2022'
__CHEETAH_src__ = '_enum_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Feb  5 13:12:19 2022'
...
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 61, col 1
            ...
            write('''": ''')
            _v = VFFSL(SL,"safe_key",True) # '${safe_key}' on line 63, col 26
            if _v is not None: write(_filter(_v, rawExpr='${safe_key}')) # from line 63, col 26.
            write(''',
''')
        write('''        }
