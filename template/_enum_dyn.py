...
__CHEETAH_genTime__ = 1643936506.3776734
__CHEETAH_genTimestamp__ = 'Thu Feb  3 20:01:46 2022'
__CHEETAH_src__ = '_enum_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Feb  3 19:57:43 2022'
...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    from ''')
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 51, col 10
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 51, col 10.
        write(''' import (''')
        _v = VFFSL(SL,"s_enum",True) # '$s_enum' on line 51, col 28
        if _v is not None: write(_filter(_v, rawExpr='$s_enum')) # from line 51, col 28.
        write(''')
