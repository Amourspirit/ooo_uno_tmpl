...
__CHEETAH_genTime__ = 1643852220.5660872
__CHEETAH_genTimestamp__ = 'Wed Feb  2 20:37:00 2022'
__CHEETAH_src__ = '_enum_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Feb  2 20:36:29 2022'
...
# Namespace: ''')
        ...
        write('''
''')
        if VFFSL(SL,"libre_office_ver",True): # generated from line 39, col 1
            write('''# Libre Office Version: ''')
            _v = VFFSL(SL,"libre_office_ver",True) # '$libre_office_ver' on line 40, col 25
            if _v is not None: write(_filter(_v, rawExpr='$libre_office_ver')) # from line 40, col 25.
            write('''
''')
...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    from ''')
        _v = VFFSL(SL,"full_name",True) # '$full_name' on line 51, col 10
        if _v is not None: write(_filter(_v, rawExpr='$full_name')) # from line 51, col 10.
        write(''' import (''')
        _v = VFFSL(SL,"s_enum",True) # '$s_enum' on line 51, col 29
        if _v is not None: write(_filter(_v, rawExpr='$s_enum')) # from line 51, col 29.
        write(''')
...
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 57, col 1
            ...
            write('''            "''')
            _v = VFFSL(SL,"safe_key",True) # '$safe_key' on line 59, col 14
            if _v is not None: write(_filter(_v, rawExpr='$safe_key')) # from line 59, col 14.
            write('''": ''')
            _v = VFFSL(SL,"safe_key",True) # '${safe_key}' on line 59, col 26
            if _v is not None: write(_filter(_v, rawExpr='${safe_key}')) # from line 59, col 26.
            write(''',
''')
        write('''        }
        ...
        write(""" = type('""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 63, col 28
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 63, col 28.
        write('''\', (object,), {
        ...
        for k, v in _dict.items():
            setattr(''')
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 68, col 21
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 68, col 21.
        write(''', k, v)
