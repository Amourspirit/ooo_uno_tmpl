...
__CHEETAH_genTime__ = 1645558443.611817
__CHEETAH_genTimestamp__ = 'Tue Feb 22 14:34:03 2022'
__CHEETAH_src__ = '_enum_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Tue Feb 22 14:34:00 2022'
...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    def _get_enum():
        ...
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 60, col 67
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 60, col 67.
        write(''' Enum. Class loosly mimics Enum",
            "__new__": uno_enum_class_new,
            "__ooo_ns__": "''')
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 62, col 28
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 62, col 28.
        write('''",
            "__ooo_full_ns__": "''')
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 63, col 33
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 63, col 33.
        write('''",
            "__ooo_type_name__": "enum",
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 65, col 1
            safe_key = VFN(VFFSL(SL,"self",True),"get_safe_word",False)(VFFSL(SL,"key",True))
            write('''            "''')
            _v = VFFSL(SL,"safe_key",True) # '$safe_key' on line 67, col 14
            if _v is not None: write(_filter(_v, rawExpr='$safe_key')) # from line 67, col 14.
            write('''": ''')
            _v = VFFSL(SL,"safe_key",True) # '${safe_key}' on line 67, col 26
            if _v is not None: write(_filter(_v, rawExpr='${safe_key}')) # from line 67, col 26.
            write(''',
''')
        write("""        }
        result = type('""")
        _v = VFFSL(SL,"safe_name",True) # '$safe_name' on line 70, col 24
        if _v is not None: write(_filter(_v, rawExpr='$safe_name')) # from line 70, col 24.
        write("""', (object,), _dict)
        return result
