...
__CHEETAH_genTime__ = 1644783085.5666547
__CHEETAH_genTimestamp__ = 'Sun Feb 13 15:11:25 2022'
__CHEETAH_src__ = '_enum_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Sun Feb 13 15:11:17 2022'
...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    from ''')
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 55, col 10
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 55, col 10.
        write(''' import (''')
        _v = VFFSL(SL,"s_enum",True) # '$s_enum' on line 55, col 28
        if _v is not None: write(_filter(_v, rawExpr='$s_enum')) # from line 55, col 28.
        write(''')
    ...
    def _dynamic_enum():
        ...
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 61, col 67
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 61, col 67.
        write(''' Enum. Class loosly mimics Enum",
            "__new__": uno_enum_class_new,
            "__ooo_ns__": "''')
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 63, col 28
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 63, col 28.
        write('''",
            "__ooo_full_ns__": "''')
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 64, col 33
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 64, col 33.
        write('''",
...
''')
        for key in VFFSL(SL,"key_list",True): # generated from line 66, col 1
            ...
            write('''            "''')
            _v = VFFSL(SL,"safe_key",True) # '$safe_key' on line 68, col 14
            if _v is not None: write(_filter(_v, rawExpr='$safe_key')) # from line 68, col 14.
            write('''": ''')
            _v = VFFSL(SL,"safe_key",True) # '${safe_key}' on line 68, col 26
            if _v is not None: write(_filter(_v, rawExpr='${safe_key}')) # from line 68, col 26.
            write(''',
''')
        write('''        }
