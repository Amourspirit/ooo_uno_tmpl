...
__CHEETAH_genTime__ = 1644276668.2290401
__CHEETAH_genTimestamp__ = 'Mon Feb  7 18:31:08 2022'
__CHEETAH_src__ = '_enum_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Mon Feb  7 18:28:45 2022'
...
''')
        ...
        write(""", '__ooo_ns__', '""")
        _v = VFFSL(SL,"namespace",True) # '$namespace' on line 73, col 44
        if _v is not None: write(_filter(_v, rawExpr='$namespace')) # from line 73, col 44.
        write("""')
        setattr(""")
        ...
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 74, col 49
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 74, col 49.
        write("""')
        setattr(""")
