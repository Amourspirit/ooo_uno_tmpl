...
__CHEETAH_genTime__ = 1725056353.8676844
__CHEETAH_genTimestamp__ = 'Fri Aug 30 18:19:13 2024'
__CHEETAH_src__ = '_enum_dyn.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Aug 30 18:18:45 2024'
...
if not TYPE_CHECKING and _DYNAMIC:
    from ''')
        ...
        write(''' import gen_dynamic_enum
    ''')
        _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 57, col 5
        if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 57, col 5.
        write(''' = gen_dynamic_enum("''')
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 57, col 38
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 57, col 38.
        write('''")
    # Dynamically created class that represents ``''')
        _v = VFFSL(SL,"fullname",True) # '$fullname' on line 58, col 51
        if _v is not None: write(_filter(_v, rawExpr='$fullname')) # from line 58, col 51.
        write('''`` Enum.
else:
    ''')
