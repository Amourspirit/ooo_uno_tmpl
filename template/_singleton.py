...
__CHEETAH_genTime__ = 1725109518.6389666
__CHEETAH_genTimestamp__ = 'Sat Aug 31 09:05:18 2024'
__CHEETAH_src__ = '_singleton.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Aug 31 09:03:23 2024'
...
""")
    ...
    @abstractmethod
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 98, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 98, col 9.
                write('''(self) -> ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 98, col 28
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 98, col 28.
                write(''':
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 100, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 101, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 101, col 9.
                    write('''
''')
                if VFN(VFFSL(SL,"self",True),"get_prop_has_errors",False)(VFFSL(SL,"property",True)): # generated from line 103, col 5
                    write('''
        Raises:

''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_get_raises",False)(VFFSL(SL,"property",True)): # generated from line 107, col 5
                        write('''            ''')
                        ...
                        write('''``
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_set_raises",False)(VFFSL(SL,"property",True)): # generated from line 110, col 5
                        write('''            ''')
...
''')
    ...
    @''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 117, col 6
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 117, col 6.
                write('''.setter
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 118, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 118, col 9.
                write('''(self, value: ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 118, col 32
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 118, col 32.
                write(''') -> None:
        ...
''')
        write("""
