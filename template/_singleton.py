...
__CHEETAH_genTime__ = 1641349096.754983
__CHEETAH_genTimestamp__ = 'Tue Jan  4 21:18:16 2022'
__CHEETAH_src__ = '_singleton.tmpl'
__CHEETAH_srcLastModified__ = 'Tue Jan  4 21:17:39 2022'
...
class ''')
        _v = VFFSL(SL,"safe_name",True) # '${safe_name}' on line 50, col 7
        if _v is not None: write(_filter(_v, rawExpr='${safe_name}')) # from line 50, col 7.
        write('''(''')
        _v = VFN(VFFSL(SL,"self",True),"get_class_inherits",False)(VFFSL(SL,"name",True), VFFSL(SL,"inherits",True)) # '$self.get_class_inherits($name, $inherits)' on line 50, col 20
        if _v is not None: write(_filter(_v, rawExpr='$self.get_class_inherits($name, $inherits)')) # from line 50, col 20.
        write(''')''')
        _v = VFN(VFFSL(SL,"self",True),"get_class_end",False)() # '$self.get_class_end()' on line 50, col 63
        if _v is not None: write(_filter(_v, rawExpr='$self.get_class_end()')) # from line 50, col 63.
        write('''
''')
        if VFFSL(SL,"include_desc",True): # generated from line 51, col 1
            write('''    """
''')
            for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"desc",True)): # generated from line 53, col 5
                write('''    ''')
                _v = VFFSL(SL,"line",True) # '$line' on line 54, col 5
                if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 54, col 5.
                write('''
''')
            if VFFSL(SL,"link",True): # generated from line 56, col 5
                write('''
    See Also:
        `API ''')
...
''')
        if VFFSL(SL,"is_properties",True): # generated from line 64, col 1
            properties = VFFSL(SL,"attribs",True)['properties']
            for property in VFFSL(SL,"properties",True): # generated from line 66, col 1
                ...
                write('''    ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 70, col 5
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 70, col 5.
                write(''': ''')
                _v = VFN(VFFSL(SL,"self",True),"get_q_type",False)(VFFSL(SL,"p_type",True)) # '$self.get_q_type($p_type)' on line 70, col 16
                if _v is not None: write(_filter(_v, rawExpr='$self.get_q_type($p_type)')) # from line 70, col 16.
                write(''' = ...
''')
                if VFFSL(SL,"include_desc",True): # generated from line 71, col 5
                    write('''    """
''')
                    for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 73, col 5
                        write('''    ''')
