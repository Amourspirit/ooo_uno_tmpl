...
__CHEETAH_genTime__ = 1643828341.4257336
__CHEETAH_genTimestamp__ = 'Wed Feb  2 13:59:01 2022'
__CHEETAH_src__ = '_singleton.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Feb  2 12:11:23 2022'
...
''')
        if VFFSL(SL,"is_properties",True): # generated from line 85, col 1
    ...
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 92, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 92, col 9.
                write('''(self) -> ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 92, col 28
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 92, col 28.
                write(''':
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 94, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 95, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 95, col 9.
                    write('''
''')
                if VFN(VFFSL(SL,"self",True),"get_prop_has_errors",False)(VFFSL(SL,"property",True)): # generated from line 97, col 5
                    write('''
        Raises:

''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_get_raises",False)(VFFSL(SL,"property",True)): # generated from line 101, col 5
                        write('''            ''')
                        _v = VFFSL(SL,"long",True) # '$long' on line 102, col 13
                        if _v is not None: write(_filter(_v, rawExpr='$long')) # from line 102, col 13.
                        write(''': get raises ``''')
                        _v = VFFSL(SL,"short",True) # '$short' on line 102, col 33
                        if _v is not None: write(_filter(_v, rawExpr='$short')) # from line 102, col 33.
                        write('''``
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_set_raises",False)(VFFSL(SL,"property",True)): # generated from line 104, col 5
                        write('''            ''')
