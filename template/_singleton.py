...
__CHEETAH_genTime__ = 1642095901.8222063
__CHEETAH_genTimestamp__ = 'Thu Jan 13 12:45:01 2022'
__CHEETAH_src__ = '_singleton.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Jan 13 12:34:42 2022'
...
''')
        ...
        write('''
''')
        if VFFSL(SL,"include_desc",True): # generated from line 57, col 1
            write('''    """
''')
            for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"desc",True)): # generated from line 59, col 5
                write('''    ''')
...
''')
        if VFFSL(SL,"is_properties",True): # generated from line 70, col 1
            properties = VFFSL(SL,"attribs",True)['properties']
            for property in VFFSL(SL,"properties",True): # generated from line 72, col 1
    ...
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 77, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 77, col 9.
                write('''(self) -> ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 77, col 28
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 77, col 28.
                write(''':
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 79, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 80, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 80, col 9.
                    write('''
''')
                if VFN(VFFSL(SL,"self",True),"get_prop_has_errors",False)(VFFSL(SL,"property",True)): # generated from line 82, col 5
                    write('''
        Raises:

''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_get_raises",False)(VFFSL(SL,"property",True)): # generated from line 86, col 5
                        write('''            ''')
                        ...
                        write('''``
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_set_raises",False)(VFFSL(SL,"property",True)): # generated from line 89, col 5
                        write('''            ''')
                        _v = VFFSL(SL,"long",True) # '$long' on line 90, col 13
                        if _v is not None: write(_filter(_v, rawExpr='$long')) # from line 90, col 13.
                        write(''': set raises ``''')
                        _v = VFFSL(SL,"short",True) # '$short' on line 90, col 33
                        if _v is not None: write(_filter(_v, rawExpr='$short')) # from line 90, col 33.
                        write('''``
''')
                write('''        """
''')
