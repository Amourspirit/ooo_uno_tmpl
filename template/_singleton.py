...
__CHEETAH_genTime__ = 1640970892.7774918
__CHEETAH_genTimestamp__ = 'Fri Dec 31 12:14:52 2021'
__CHEETAH_src__ = '_singleton.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Dec 31 12:13:38 2021'
...
''')
        for frm, imp in VFFSL(SL,"from_imports",True): # generated from line 34, col 1
            ...
            write('''
''')
        if len(VFFSL(SL,"from_imports_typing",True)) > 0: # generated from line 37, col 1
            write('''if typing.TYPE_CHECKING:
''')
            for frm, imp in VFFSL(SL,"from_imports_typing",True): # generated from line 39, col 1
                write('''    from ''')
                _v = VFFSL(SL,"frm",True) # '$frm' on line 40, col 10
                if _v is not None: write(_filter(_v, rawExpr='$frm')) # from line 40, col 10.
                write(''' import ''')
                _v = VFFSL(SL,"imp",True) # '$imp' on line 40, col 22
                if _v is not None: write(_filter(_v, rawExpr='$imp')) # from line 40, col 22.
                write('''
''')
        write('''
...
class ''')
        ...
        write('''(''')
        _v = VFN(VFFSL(SL,"self",True),"lst_to_str",False)(VFFSL(SL,"inherits",True)) # '$self.lst_to_str($inherits)' on line 45, col 20
        if _v is not None: write(_filter(_v, rawExpr='$self.lst_to_str($inherits)')) # from line 45, col 20.
        write(''')''')
        _v = VFN(VFFSL(SL,"self",True),"get_class_end",False)() # '$self.get_class_end()' on line 45, col 48
        if _v is not None: write(_filter(_v, rawExpr='$self.get_class_end()')) # from line 45, col 48.
        write('''
''')
        if VFFSL(SL,"include_desc",True): # generated from line 46, col 1
            write('''    """
''')
            for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"desc",True)): # generated from line 48, col 5
                write('''    ''')
                _v = VFFSL(SL,"line",True) # '$line' on line 49, col 5
                if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 49, col 5.
                write('''
''')
            if VFFSL(SL,"link",True): # generated from line 51, col 5
                write('''
    See Also:
        `API ''')
...
''')
        if VFFSL(SL,"is_properties",True): # generated from line 59, col 1
            properties = VFFSL(SL,"attribs",True)['properties']
            for property in VFFSL(SL,"properties",True): # generated from line 61, col 1
                ...
                write('''    ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 65, col 5
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 65, col 5.
                write(''': ''')
                _v = VFN(VFFSL(SL,"self",True),"get_q_type",False)(VFFSL(SL,"p_type",True)) # '$self.get_q_type($p_type)' on line 65, col 16
                if _v is not None: write(_filter(_v, rawExpr='$self.get_q_type($p_type)')) # from line 65, col 16.
                write(''' = ...
''')
                if VFFSL(SL,"include_desc",True): # generated from line 66, col 5
                    write('''    """
''')
                    for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 68, col 5
                        write('''    ''')
