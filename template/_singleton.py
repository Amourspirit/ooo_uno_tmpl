...
__CHEETAH_genTime__ = 1642286034.7637622
__CHEETAH_genTimestamp__ = 'Sat Jan 15 17:33:54 2022'
__CHEETAH_src__ = '_singleton.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Jan 15 17:32:25 2022'
...
''')
        if VFFSL(SL,"is_properties",True): # generated from line 71, col 1
            properties = VFFSL(SL,"attribs",True)['properties']
            for property in VFFSL(SL,"properties",True): # generated from line 73, col 1
    ...
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 78, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 78, col 9.
                write('''(self) -> ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 78, col 28
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 78, col 28.
                write(''':
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 80, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 81, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 81, col 9.
                    write('''
''')
                if VFN(VFFSL(SL,"self",True),"get_prop_has_errors",False)(VFFSL(SL,"property",True)): # generated from line 83, col 5
                    write('''
        Raises:

''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_get_raises",False)(VFFSL(SL,"property",True)): # generated from line 87, col 5
                        write('''            ''')
                        _v = VFFSL(SL,"long",True) # '$long' on line 88, col 13
                        if _v is not None: write(_filter(_v, rawExpr='$long')) # from line 88, col 13.
                        write(''': get raises ``''')
                        _v = VFFSL(SL,"short",True) # '$short' on line 88, col 33
                        if _v is not None: write(_filter(_v, rawExpr='$short')) # from line 88, col 33.
                        write('''``
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_set_raises",False)(VFFSL(SL,"property",True)): # generated from line 90, col 5
                        write('''            ''')
