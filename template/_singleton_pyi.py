...
__CHEETAH_genTime__ = 1649894933.9919806
__CHEETAH_genTimestamp__ = 'Wed Apr 13 20:08:53 2022'
__CHEETAH_src__ = '_singleton_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Apr 13 20:08:40 2022'
...
''')
        if VFFSL(SL,"is_properties",True): # generated from line 78, col 1
            properties = VFFSL(SL,"attribs",True)['properties']
            for property in VFFSL(SL,"properties",True): # generated from line 80, col 1
                ...
                write('''    @aproperty
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 85, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 85, col 9.
                write('''(self) -> ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 85, col 28
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 85, col 28.
                write(''':
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 87, col 5
                    write('''        ''')
                    _v = VFFSL(SL,"line",True) # '$line' on line 88, col 9
                    if _v is not None: write(_filter(_v, rawExpr='$line')) # from line 88, col 9.
                    write('''
''')
                if VFN(VFFSL(SL,"self",True),"get_prop_has_errors",False)(VFFSL(SL,"property",True)): # generated from line 90, col 5
                    write('''
        Raises:

''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_get_raises",False)(VFFSL(SL,"property",True)): # generated from line 94, col 5
                        write('''            ''')
                        ...
                        write('''``
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_set_raises",False)(VFFSL(SL,"property",True)): # generated from line 97, col 5
                        write('''            ''')
