...
__CHEETAH_genTime__ = 1684083488.0743542
__CHEETAH_genTimestamp__ = 'Sun May 14 12:58:08 2023'
__CHEETAH_src__ = '_singleton_pyi.tmpl'
__CHEETAH_srcLastModified__ = 'Sun May 14 12:55:21 2023'
...
class singleton_pyi(BaseSingletonDyn):
    ...
    def __init__(self, *args, **KWs):
        ...
        super(singleton_pyi, self).__init__(*args, **KWs)
...
''')
            write('''    """
''')
            if VFFSL(SL,"is_properties",True) is False: # generated from line 76, col 1
                write('''    ...
''')
            write('''
''')
        if VFFSL(SL,"is_properties",True): # generated from line 81, col 1
            properties = VFFSL(SL,"attribs",True)['properties']
            for property in VFFSL(SL,"properties",True): # generated from line 83, col 1
                ...
                write('''    @property
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 88, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 88, col 9.
                write('''(self) -> ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 88, col 28
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 88, col 28.
                write(''':
        """
''')
                for line in VFN(VFFSL(SL,"self",True),"line_gen",False)(VFFSL(SL,"p_desc",True)): # generated from line 90, col 5
                    ...
                    write('''
''')
                if VFN(VFFSL(SL,"self",True),"get_prop_has_errors",False)(VFFSL(SL,"property",True)): # generated from line 93, col 5
                    write('''
        Raises:

''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_get_raises",False)(VFFSL(SL,"property",True)): # generated from line 97, col 5
                        write('''            ''')
                        _v = VFFSL(SL,"long",True) # '$long' on line 98, col 13
                        if _v is not None: write(_filter(_v, rawExpr='$long')) # from line 98, col 13.
                        write(''': get raises ``''')
                        _v = VFFSL(SL,"short",True) # '$short' on line 98, col 33
                        if _v is not None: write(_filter(_v, rawExpr='$short')) # from line 98, col 33.
                        write('''``
''')
                    for long, short in VFN(VFFSL(SL,"self",True),"get_prop_set_raises",False)(VFFSL(SL,"property",True)): # generated from line 100, col 5
                        write('''            ''')
...
''')
        ...
        ...
    @''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 106, col 6
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 106, col 6.
                write('''.setter
    def ''')
                _v = VFFSL(SL,"p_name",True) # '${p_name}' on line 107, col 9
                if _v is not None: write(_filter(_v, rawExpr='${p_name}')) # from line 107, col 9.
                write('''(self, value: ''')
                _v = VFFSL(SL,"p_return",True) # '$p_return' on line 107, col 32
                if _v is not None: write(_filter(_v, rawExpr='$p_return')) # from line 107, col 32.
                write(''') -> None:
        ...
''')
    ...
    _mainCheetahMethod_for_singleton_pyi = 'respond'

## END CLASS DEFINITION

if not hasattr(singleton_pyi, '_initCheetahAttributes'):
    templateAPIClass = getattr(singleton_pyi,
                               '_CHEETAH_templateClass',
                               Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(singleton_pyi)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=singleton_pyi()).run()
